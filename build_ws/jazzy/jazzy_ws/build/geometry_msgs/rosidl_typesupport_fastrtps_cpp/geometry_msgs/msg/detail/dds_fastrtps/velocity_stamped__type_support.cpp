...
#include "geometry_msgs/msg/detail/velocity_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::VelocityStamped;
    is_plain =
      (
...
static size_t _VelocityStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VelocityStamped(full_bounded, is_plain, 0);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_VelocityStamped__handle;
}
