  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::TransformStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::TransformStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::TransformStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TransformStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::TransformStamped *>(
...
static size_t _TransformStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TransformStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TransformStamped__callbacks = {
  "geometry_msgs::msg",
  "TransformStamped",
...
static rosidl_message_type_support_t _TransformStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TransformStamped__callbacks,
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_TransformStamped__handle;
}
