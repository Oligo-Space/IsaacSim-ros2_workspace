...
#include "geometry_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::Pose2D;
    is_plain =
      (
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
