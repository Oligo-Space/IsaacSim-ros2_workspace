...
#include "geometry_msgs/msg/detail/twist_with_covariance_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::TwistWithCovarianceStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::TwistWithCovarianceStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::TwistWithCovarianceStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TwistWithCovarianceStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::TwistWithCovarianceStamped *>(
...
static size_t _TwistWithCovarianceStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TwistWithCovarianceStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TwistWithCovarianceStamped__callbacks = {
  "geometry_msgs::msg",
...
static rosidl_message_type_support_t _TwistWithCovarianceStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TwistWithCovarianceStamped__callbacks,
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_TwistWithCovarianceStamped__handle;
}
