  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::PoseStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::PoseStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::PoseStamped *>(
    untyped_ros_message);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_PoseStamped__handle;
}
