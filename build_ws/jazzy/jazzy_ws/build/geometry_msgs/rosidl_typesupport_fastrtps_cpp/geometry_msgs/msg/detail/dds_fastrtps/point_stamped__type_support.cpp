  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::PointStamped;
    is_plain =
      (
...
static size_t _PointStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PointStamped(full_bounded, is_plain, 0);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_PointStamped__handle;
}
