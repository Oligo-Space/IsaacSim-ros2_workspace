...
#include "geometry_msgs/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::Point;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::Point *>(
    untyped_ros_message);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_Point__handle;
}
