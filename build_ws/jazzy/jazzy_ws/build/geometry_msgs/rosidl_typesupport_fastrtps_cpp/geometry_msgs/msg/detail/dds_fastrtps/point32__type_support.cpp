...
#include "geometry_msgs/msg/detail/point32__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::Point32;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Point32__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Point32(full_bounded, is_plain, 0);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_Point32__handle;
}
