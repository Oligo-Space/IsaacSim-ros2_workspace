...
#include "geometry_msgs/msg/detail/accel_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::AccelStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::AccelStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::AccelStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AccelStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::AccelStamped *>(
...
static size_t _AccelStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AccelStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AccelStamped__callbacks = {
  "geometry_msgs::msg",
  "AccelStamped",
...
static rosidl_message_type_support_t _AccelStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AccelStamped__callbacks,
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_AccelStamped__handle;
}
