...
#include "geometry_msgs/msg/detail/quaternion__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::Quaternion;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
