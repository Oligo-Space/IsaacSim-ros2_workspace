...
#include "geometry_msgs/msg/detail/pose_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::PoseArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::PoseArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::PoseArray *>(
    untyped_ros_message);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_PoseArray__handle;
}
