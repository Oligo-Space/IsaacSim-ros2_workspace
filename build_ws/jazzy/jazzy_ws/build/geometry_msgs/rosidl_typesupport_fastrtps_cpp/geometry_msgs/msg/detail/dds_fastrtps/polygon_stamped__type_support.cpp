...
#include "geometry_msgs/msg/detail/polygon_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::PolygonStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::PolygonStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<geometry_msgs::msg::PolygonStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PolygonStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const geometry_msgs::msg::PolygonStamped *>(
...
static size_t _PolygonStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PolygonStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PolygonStamped__callbacks = {
  "geometry_msgs::msg",
  "PolygonStamped",
...
static rosidl_message_type_support_t _PolygonStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PolygonStamped__callbacks,
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_PolygonStamped__handle;
}
