...
static char vision_msgs__msg__Detection3D__FIELD_NAME__header[] = "header";
static char vision_msgs__msg__Detection3D__FIELD_NAME__results[] = "results";
static char vision_msgs__msg__Detection3D__FIELD_NAME__bbox[] = "bbox";
static char vision_msgs__msg__Detection3D__FIELD_NAME__id[] = "id";

static rosidl_runtime_c__type_description__Field vision_msgs__msg__Detection3D__FIELDS[] = {
  {
    {vision_msgs__msg__Detection3D__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {vision_msgs__msg__Detection3D__FIELD_NAME__results, 7, 7},
    {
  ...
  {
    {vision_msgs__msg__Detection3D__FIELD_NAME__bbox, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {vision_msgs__msg__Detection3D__FIELD_NAME__id, 2, 2},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription vision_msgs__msg__Detection3D__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {vision_msgs__msg__Detection3D__FIELDS, 4, 4},
    },
    {vision_msgs__msg__Detection3D__REFERENCED_TYPE_DESCRIPTIONS, 10, 10},
  };
  if (!constructed) {
...
vision_msgs__msg__Detection3D__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {vision_msgs__msg__Detection3D__TYPE_NAME, 27, 27},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 826, 826},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *vision_msgs__msg__Detection3D__get_individual_type_description_source(NULL),
