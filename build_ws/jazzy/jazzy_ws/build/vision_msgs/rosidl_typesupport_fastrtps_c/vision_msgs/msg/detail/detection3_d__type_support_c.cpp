...
bool cdr_serialize_vision_msgs__msg__BoundingBox3D(
  const vision_msgs__msg__BoundingBox3D * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_vision_msgs__msg__BoundingBox3D(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs__msg__BoundingBox3D * ros_message);
...
bool cdr_serialize_key_vision_msgs__msg__BoundingBox3D(
  const vision_msgs__msg__BoundingBox3D * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_vision_msgs__msg__BoundingBox3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_vision_msgs__msg__BoundingBox3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_vision_msgs__msg__Detection3D(
  const vision_msgs__msg__Detection3D * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: results
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_vision_msgs__msg__ObjectHypothesisWithPose(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: bbox
  {
    cdr_serialize_vision_msgs__msg__BoundingBox3D(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
bool cdr_deserialize_vision_msgs__msg__Detection3D(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs__msg__Detection3D * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: results
  {
    ...
    auto array_ptr = ros_message->results.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_vision_msgs__msg__ObjectHypothesisWithPose(cdr, &array_ptr[i]);
    }
  }

  // Field name: bbox
  {
    cdr_deserialize_vision_msgs__msg__BoundingBox3D(cdr, &ros_message->bbox);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
bool cdr_serialize_key_vision_msgs__msg__Detection3D(
  const vision_msgs__msg__Detection3D * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: results
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_vision_msgs__msg__ObjectHypothesisWithPose(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: bbox
  {
    cdr_serialize_key_vision_msgs__msg__BoundingBox3D(
      &ros_message->bbox, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t get_serialized_size_key_vision_msgs__msg__Detection3D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection3D__ros_msg_type * ros_message = static_cast<const _Detection3D__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: results
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_vision_msgs__msg__ObjectHypothesisWithPose(
        &array_ptr[index], current_alignment);
    }
  }

  // Field name: bbox
  current_alignment += get_serialized_size_key_vision_msgs__msg__BoundingBox3D(
    &(ros_message->bbox), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t max_serialized_size_key_vision_msgs__msg__Detection3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: results
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_vision_msgs__msg__ObjectHypothesisWithPose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_vision_msgs__msg__BoundingBox3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__Detection3D * ros_message = static_cast<const vision_msgs__msg__Detection3D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__Detection3D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__Detection3D * ros_message = static_cast<vision_msgs__msg__Detection3D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__Detection3D(cdr, ros_message);
}
