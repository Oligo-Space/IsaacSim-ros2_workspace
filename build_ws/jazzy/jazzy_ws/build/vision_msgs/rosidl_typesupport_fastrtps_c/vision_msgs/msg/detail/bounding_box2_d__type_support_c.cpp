...
bool cdr_serialize_vision_msgs__msg__Pose2D(
  const vision_msgs__msg__Pose2D * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_vision_msgs__msg__Pose2D(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs__msg__Pose2D * ros_message);
...
bool cdr_serialize_key_vision_msgs__msg__Pose2D(
  const vision_msgs__msg__Pose2D * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_vision_msgs__msg__Pose2D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_vision_msgs__msg__Pose2D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: center
  {
    cdr_serialize_vision_msgs__msg__Pose2D(
  ...
  vision_msgs__msg__BoundingBox2D * ros_message)
{
  // Field name: center
  {
    cdr_deserialize_vision_msgs__msg__Pose2D(cdr, &ros_message->center);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: center
  {
    cdr_serialize_key_vision_msgs__msg__Pose2D(
      &ros_message->center, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: center
  current_alignment += get_serialized_size_key_vision_msgs__msg__Pose2D(
    &(ros_message->center), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: center
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_vision_msgs__msg__Pose2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__BoundingBox2D * ros_message = static_cast<const vision_msgs__msg__BoundingBox2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__BoundingBox2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__BoundingBox2D * ros_message = static_cast<vision_msgs__msg__BoundingBox2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__BoundingBox2D(cdr, ros_message);
}
