...
bool cdr_serialize_vision_msgs__msg__Detection2D(
  const vision_msgs__msg__Detection2D * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
bool cdr_deserialize_vision_msgs__msg__Detection2D(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs__msg__Detection2D * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
bool cdr_serialize_key_vision_msgs__msg__Detection2D(
  const vision_msgs__msg__Detection2D * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t get_serialized_size_key_vision_msgs__msg__Detection2D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection2D__ros_msg_type * ros_message = static_cast<const _Detection2D__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t max_serialized_size_key_vision_msgs__msg__Detection2D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__Detection2D * ros_message = static_cast<const vision_msgs__msg__Detection2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__Detection2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__Detection2D * ros_message = static_cast<vision_msgs__msg__Detection2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__Detection2D(cdr, ros_message);
}
