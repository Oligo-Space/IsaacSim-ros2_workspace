...
bool cdr_serialize_vision_msgs__msg__VisionInfo(
  const vision_msgs__msg__VisionInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
bool cdr_deserialize_vision_msgs__msg__VisionInfo(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs__msg__VisionInfo * ros_message)
{
  // Field name: header
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs__msg__VisionInfo;
    is_plain =
      (
      offsetof(DataType, database_version) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
bool cdr_serialize_key_vision_msgs__msg__VisionInfo(
  const vision_msgs__msg__VisionInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t get_serialized_size_key_vision_msgs__msg__VisionInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VisionInfo__ros_msg_type * ros_message = static_cast<const _VisionInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t max_serialized_size_key_vision_msgs__msg__VisionInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__VisionInfo * ros_message = static_cast<const vision_msgs__msg__VisionInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__VisionInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__VisionInfo * ros_message = static_cast<vision_msgs__msg__VisionInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__VisionInfo(cdr, ros_message);
}
