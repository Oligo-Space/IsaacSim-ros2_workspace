  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_vision_msgs__msg__Detection2D(
        &array_ptr[i], cdr);
    }
  }
  ...
  vision_msgs__msg__Detection2DArray * ros_message)
{
  ...
  // Field name: detections
  {
    ...
    auto array_ptr = ros_message->detections.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_vision_msgs__msg__Detection2D(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs__msg__Detection2DArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_vision_msgs__msg__Detection2D(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: detections
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_vision_msgs__msg__Detection2D(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_vision_msgs__msg__Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__Detection2DArray * ros_message = static_cast<const vision_msgs__msg__Detection2DArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__Detection2DArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__Detection2DArray * ros_message = static_cast<vision_msgs__msg__Detection2DArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__Detection2DArray(cdr, ros_message);
}
