  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__ObjectHypothesis * ros_message = static_cast<const vision_msgs__msg__ObjectHypothesis *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__ObjectHypothesis(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__ObjectHypothesis * ros_message = static_cast<vision_msgs__msg__ObjectHypothesis *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__ObjectHypothesis(cdr, ros_message);
}
