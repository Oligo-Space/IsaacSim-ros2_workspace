  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs__msg__Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_msgs__msg__Point2D * ros_message = static_cast<const vision_msgs__msg__Point2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_msgs__msg__Point2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_msgs__msg__Point2D * ros_message = static_cast<vision_msgs__msg__Point2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_msgs__msg__Point2D(cdr, ros_message);
}
