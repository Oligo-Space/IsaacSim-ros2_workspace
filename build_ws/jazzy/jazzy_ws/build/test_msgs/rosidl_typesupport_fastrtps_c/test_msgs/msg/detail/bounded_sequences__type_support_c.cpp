  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const test_msgs__msg__BoundedSequences * ros_message = static_cast<const test_msgs__msg__BoundedSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_test_msgs__msg__BoundedSequences(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  test_msgs__msg__BoundedSequences * ros_message = static_cast<test_msgs__msg__BoundedSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_test_msgs__msg__BoundedSequences(cdr, ros_message);
}
