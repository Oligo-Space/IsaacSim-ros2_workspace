...
#include "test_msgs/msg/detail/unbounded_sequences__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_msgs__msg__UnboundedSequences;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const test_msgs__msg__UnboundedSequences * ros_message = static_cast<const test_msgs__msg__UnboundedSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_test_msgs__msg__UnboundedSequences(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  test_msgs__msg__UnboundedSequences * ros_message = static_cast<test_msgs__msg__UnboundedSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_test_msgs__msg__UnboundedSequences(cdr, ros_message);
}
...
static size_t _UnboundedSequences__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_msgs__msg__UnboundedSequences(
