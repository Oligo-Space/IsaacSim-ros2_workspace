  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const test_msgs__msg__BoundedPlainSequences * ros_message = static_cast<const test_msgs__msg__BoundedPlainSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_test_msgs__msg__BoundedPlainSequences(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  test_msgs__msg__BoundedPlainSequences * ros_message = static_cast<test_msgs__msg__BoundedPlainSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_test_msgs__msg__BoundedPlainSequences(cdr, ros_message);
}

static uint32_t _BoundedPlainSequences__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_msgs__msg__BoundedPlainSequences(
...
static size_t _BoundedPlainSequences__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_msgs__msg__BoundedPlainSequences(
