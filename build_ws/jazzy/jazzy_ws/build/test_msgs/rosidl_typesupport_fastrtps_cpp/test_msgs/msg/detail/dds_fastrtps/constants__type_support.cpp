...
#include "test_msgs/msg/detail/constants__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_msgs::msg::Constants;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const test_msgs::msg::Constants *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_msgs::msg::Constants *>(
    untyped_ros_message);
...
{
  return &test_msgs::msg::typesupport_fastrtps_cpp::_Constants__handle;
}
