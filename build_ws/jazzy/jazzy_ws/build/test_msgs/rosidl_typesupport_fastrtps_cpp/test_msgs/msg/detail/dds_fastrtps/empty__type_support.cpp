...
#include "test_msgs/msg/detail/empty__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_msgs::msg::Empty;
    is_plain =
      (
...
{
  return &test_msgs::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
