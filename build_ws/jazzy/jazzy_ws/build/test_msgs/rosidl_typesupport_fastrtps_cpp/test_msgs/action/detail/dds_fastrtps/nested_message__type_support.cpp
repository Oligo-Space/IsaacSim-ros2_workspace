  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_msgs::action::NestedMessage_Goal;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: nested_field_no_pkg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Builtins(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _NestedMessage_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_Goal(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for test_msgs::msg::Builtins already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_Result;
    is_plain =
      (
      offsetof(DataType, nested_different_pkg) +
      last_member_size
...
static size_t _NestedMessage_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_Result(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_Feedback;
    is_plain =
      (
      offsetof(DataType, nested_different_pkg) +
      last_member_size
...
static size_t _NestedMessage_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_Feedback(full_bounded, is_plain, 0);
...
// functions for test_msgs::action::NestedMessage_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_SendGoal_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _NestedMessage_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_SendGoal_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_SendGoal_Response;
    is_plain =
      (
...
static size_t _NestedMessage_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_SendGoal_Response(full_bounded, is_plain, 0);
...
// functions for test_msgs::action::NestedMessage_SendGoal_Request already declared above

// functions for test_msgs::action::NestedMessage_SendGoal_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NestedMessage_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NestedMessage_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_SendGoal_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const test_msgs::action::NestedMessage_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_msgs::action::NestedMessage_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NestedMessage_SendGoal_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const test_msgs::action::NestedMessage_SendGoal_Event *>(
...
static size_t _NestedMessage_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_SendGoal_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NestedMessage_SendGoal_Event__callbacks = {
  "test_msgs::action",
...
static rosidl_message_type_support_t _NestedMessage_SendGoal_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NestedMessage_SendGoal_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &test_msgs::action::typesupport_fastrtps_cpp::_NestedMessage_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _NestedMessage_SendGoal__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NestedMessage_SendGoal__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<test_msgs::action::NestedMessage_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<test_msgs::action::NestedMessage_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<test_msgs::action::NestedMessage_SendGoal_Event>(),
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_GetResult_Request;
    is_plain =
      (
...
static size_t _NestedMessage_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_GetResult_Request(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for test_msgs::action::NestedMessage_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_GetResult_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _NestedMessage_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_GetResult_Response(full_bounded, is_plain, 0);
...
// functions for test_msgs::action::NestedMessage_GetResult_Request already declared above

// functions for test_msgs::action::NestedMessage_GetResult_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NestedMessage_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NestedMessage_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const test_msgs::action::NestedMessage_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_msgs::action::NestedMessage_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NestedMessage_GetResult_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const test_msgs::action::NestedMessage_GetResult_Event *>(
...
static size_t _NestedMessage_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_GetResult_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NestedMessage_GetResult_Event__callbacks = {
  "test_msgs::action",
...
static rosidl_message_type_support_t _NestedMessage_GetResult_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NestedMessage_GetResult_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &test_msgs::action::typesupport_fastrtps_cpp::_NestedMessage_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _NestedMessage_GetResult__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NestedMessage_GetResult__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<test_msgs::action::NestedMessage_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<test_msgs::action::NestedMessage_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<test_msgs::action::NestedMessage_GetResult_Event>(),
...
// functions for test_msgs::action::NestedMessage_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_msgs::action::NestedMessage_FeedbackMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_NestedMessage_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _NestedMessage_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NestedMessage_FeedbackMessage(full_bounded, is_plain, 0);
