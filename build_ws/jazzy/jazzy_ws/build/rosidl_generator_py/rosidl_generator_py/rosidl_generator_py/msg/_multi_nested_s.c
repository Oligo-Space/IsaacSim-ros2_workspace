...
bool rosidl_generator_py__msg__arrays__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool rosidl_generator_py__msg__multi_nested__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_generator_py.msg._multi_nested.MultiNested", full_classname_dest, 49) == 0);
  }
  rosidl_generator_py__msg__MultiNested * ros_message = _ros_message;
  {  // array_of_arrays
    ...
    Py_ssize_t size = 3;
    rosidl_generator_py__msg__Arrays * dest = ros_message->array_of_arrays;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__arrays__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // array_of_bounded_sequences
    ...
    Py_ssize_t size = 3;
    rosidl_generator_py__msg__BoundedSequences * dest = ros_message->array_of_bounded_sequences;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__bounded_sequences__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // array_of_unbounded_sequences
    ...
    Py_ssize_t size = 3;
    rosidl_generator_py__msg__UnboundedSequences * dest = ros_message->array_of_unbounded_sequences;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__unbounded_sequences__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // bounded_sequence_of_arrays
    ...
    if (!rosidl_generator_py__msg__Arrays__Sequence__init(&(ros_message->bounded_sequence_of_arrays), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rosidl_generator_py__msg__Arrays__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_py__msg__Arrays * dest = ros_message->bounded_sequence_of_arrays.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__arrays__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // bounded_sequence_of_bounded_sequences
    ...
    if (!rosidl_generator_py__msg__BoundedSequences__Sequence__init(&(ros_message->bounded_sequence_of_bounded_sequences), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rosidl_generator_py__msg__BoundedSequences__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_py__msg__BoundedSequences * dest = ros_message->bounded_sequence_of_bounded_sequences.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__bounded_sequences__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // bounded_sequence_of_unbounded_sequences
    ...
    if (!rosidl_generator_py__msg__UnboundedSequences__Sequence__init(&(ros_message->bounded_sequence_of_unbounded_sequences), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rosidl_generator_py__msg__UnboundedSequences__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_py__msg__UnboundedSequences * dest = ros_message->bounded_sequence_of_unbounded_sequences.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__unbounded_sequences__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // unbounded_sequence_of_arrays
    ...
    rosidl_generator_py__msg__Arrays * dest = ros_message->unbounded_sequence_of_arrays.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__arrays__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // unbounded_sequence_of_bounded_sequences
    ...
    rosidl_generator_py__msg__BoundedSequences * dest = ros_message->unbounded_sequence_of_bounded_sequences.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__bounded_sequences__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // unbounded_sequence_of_unbounded_sequences
    ...
    rosidl_generator_py__msg__UnboundedSequences * dest = ros_message->unbounded_sequence_of_unbounded_sequences.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosidl_generator_py__msg__unbounded_sequences__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
PyObject * rosidl_generator_py__msg__multi_nested__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosidl_generator_py.msg._multi_nested");
  ...
  {  // array_of_arrays
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rosidl_generator_py__msg__arrays__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // array_of_bounded_sequences
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rosidl_generator_py__msg__bounded_sequences__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // array_of_unbounded_sequences
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rosidl_generator_py__msg__unbounded_sequences__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
