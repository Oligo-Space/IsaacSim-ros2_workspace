    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rosidl_generator_py.msg.MultiNested')
            logger.debug(
...
class MultiNested(metaclass=Metaclass_MultiNested):
    ...
    _fields_and_field_types = {
        'array_of_arrays': 'rosidl_generator_py/Arrays[3]',
        'array_of_bounded_sequences': 'rosidl_generator_py/BoundedSequences[3]',
        'array_of_unbounded_sequences': 'rosidl_generator_py/UnboundedSequences[3]',
        'bounded_sequence_of_arrays': 'sequence<rosidl_generator_py/Arrays, 3>',
        'bounded_sequence_of_bounded_sequences': 'sequence<rosidl_generator_py/BoundedSequences, 3>',
        'bounded_sequence_of_unbounded_sequences': 'sequence<rosidl_generator_py/UnboundedSequences, 3>',
        'unbounded_sequence_of_arrays': 'sequence<rosidl_generator_py/Arrays>',
        'unbounded_sequence_of_bounded_sequences': 'sequence<rosidl_generator_py/BoundedSequences>',
        'unbounded_sequence_of_unbounded_sequences': 'sequence<rosidl_generator_py/UnboundedSequences>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'Arrays'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'BoundedSequences'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'UnboundedSequences'), 3),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'Arrays'), 3),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'BoundedSequences'), 3),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'UnboundedSequences'), 3),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'Arrays')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'BoundedSequences')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'UnboundedSequences')),  # noqa: E501
    )
