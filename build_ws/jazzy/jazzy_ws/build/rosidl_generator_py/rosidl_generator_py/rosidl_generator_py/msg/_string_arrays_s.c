...
bool rosidl_generator_py__msg__string_arrays__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_generator_py.msg._string_arrays.StringArrays", full_classname_dest, 51) == 0);
  }
  ...
  {  // ub_string_static_array_value
    ...
    }
    {
      ...
      Py_ssize_t size = 3;
      rosidl_runtime_c__String * dest = ros_message->ub_string_static_array_value;
  ...
  {  // ub_string_ub_array_value
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->ub_string_ub_array_value.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // ub_string_dynamic_array_value
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->ub_string_dynamic_array_value.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // string_dynamic_array_value
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->string_dynamic_array_value.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // string_static_array_value
    ...
    }
    {
      ...
      Py_ssize_t size = 3;
      rosidl_runtime_c__String * dest = ros_message->string_static_array_value;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // string_bounded_array_value
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->string_bounded_array_value.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // def_string_dynamic_array_value
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->def_string_dynamic_array_value.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // def_string_static_array_value
    ...
    }
    {
      ...
      Py_ssize_t size = 3;
      rosidl_runtime_c__String * dest = ros_message->def_string_static_array_value;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // def_string_bounded_array_value
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->def_string_bounded_array_value.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // def_various_quotes
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->def_various_quotes.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // def_various_commas
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->def_various_commas.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
PyObject * rosidl_generator_py__msg__string_arrays__convert_to_py(void * raw_ros_message)
{
  ...
  {  // ub_string_static_array_value
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_runtime_c__String * src = ros_message->ub_string_static_array_value;
  ...
  {  // ub_string_ub_array_value
    ...
    rosidl_runtime_c__String * src = ros_message->ub_string_ub_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // ub_string_dynamic_array_value
    ...
    rosidl_runtime_c__String * src = ros_message->ub_string_dynamic_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // string_dynamic_array_value
    ...
    rosidl_runtime_c__String * src = ros_message->string_dynamic_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // string_static_array_value
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_runtime_c__String * src = ros_message->string_static_array_value;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // string_bounded_array_value
    ...
    rosidl_runtime_c__String * src = ros_message->string_bounded_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // def_string_dynamic_array_value
    ...
    rosidl_runtime_c__String * src = ros_message->def_string_dynamic_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // def_string_static_array_value
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_runtime_c__String * src = ros_message->def_string_static_array_value;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // def_string_bounded_array_value
    ...
    rosidl_runtime_c__String * src = ros_message->def_string_bounded_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // def_various_quotes
    ...
    rosidl_runtime_c__String * src = ros_message->def_various_quotes.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // def_various_commas
    ...
    rosidl_runtime_c__String * src = ros_message->def_various_commas.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
