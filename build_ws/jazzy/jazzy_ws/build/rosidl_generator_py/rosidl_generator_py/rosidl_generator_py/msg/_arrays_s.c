...
bool rosidl_generator_py__msg__arrays__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_generator_py.msg._arrays.Arrays", full_classname_dest, 38) == 0);
  }
  rosidl_generator_py__msg__Arrays * ros_message = _ros_message;
  {  // bool_values
  ...
  {  // basic_types_values
    ...
    Py_ssize_t size = 3;
    rosidl_generator_py__msg__BasicTypes * dest = ros_message->basic_types_values;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // constants_values
    ...
    Py_ssize_t size = 3;
    rosidl_generator_py__msg__Constants * dest = ros_message->constants_values;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // defaults_values
    ...
    Py_ssize_t size = 3;
    rosidl_generator_py__msg__Defaults * dest = ros_message->defaults_values;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * rosidl_generator_py__msg__arrays__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosidl_generator_py.msg._arrays");
