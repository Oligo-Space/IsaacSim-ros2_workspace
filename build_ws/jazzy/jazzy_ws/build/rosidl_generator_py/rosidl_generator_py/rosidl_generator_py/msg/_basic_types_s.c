...
bool rosidl_generator_py__msg__basic_types__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_generator_py.msg._basic_types.BasicTypes", full_classname_dest, 47) == 0);
  }
  rosidl_generator_py__msg__BasicTypes * ros_message = _ros_message;
  {  // bool_value
...
{
  /* NOTE(esteve): Call constructor of BasicTypes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosidl_generator_py.msg._basic_types");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BasicTypes");
