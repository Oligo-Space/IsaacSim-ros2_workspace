    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rosidl_generator_py.msg.Arrays')
            logger.debug(
...
class Arrays(metaclass=Metaclass_Arrays):
    ...
    _fields_and_field_types = {
        ...
        'basic_types_values': 'rosidl_generator_py/BasicTypes[3]',
        'constants_values': 'rosidl_generator_py/Constants[3]',
        'defaults_values': 'rosidl_generator_py/Defaults[3]',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'BasicTypes'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'Constants'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rosidl_generator_py', 'msg'], 'Defaults'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('boolean'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('octet'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('uint8'), 3),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('float'), 3),  # noqa: E501
