...
bool rosidl_generator_py__msg__w_strings__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_generator_py.msg._w_strings.WStrings", full_classname_dest, 43) == 0);
  }
  rosidl_generator_py__msg__WStrings * ros_message = _ros_message;
  {  // wstring_value
...
PyObject * rosidl_generator_py__msg__w_strings__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosidl_generator_py.msg._w_strings");
