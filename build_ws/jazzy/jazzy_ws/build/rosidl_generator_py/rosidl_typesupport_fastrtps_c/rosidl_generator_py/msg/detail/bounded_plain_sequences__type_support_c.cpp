...
#include "rosidl_generator_py/msg/detail/bounded_plain_sequences__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_py/msg/detail/basic_types__functions.h"  // basic_types_values
#include "rosidl_generator_py/msg/detail/constants__functions.h"  // constants_values
#include "rosidl_generator_py/msg/detail/defaults__functions.h"  // defaults_values
...
bool cdr_serialize_rosidl_generator_py__msg__BasicTypes(
  const rosidl_generator_py__msg__BasicTypes * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_rosidl_generator_py__msg__BasicTypes(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py__msg__BasicTypes * ros_message);
...
bool cdr_serialize_key_rosidl_generator_py__msg__BasicTypes(
  const rosidl_generator_py__msg__BasicTypes * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_rosidl_generator_py__msg__BasicTypes(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_rosidl_generator_py__msg__BasicTypes(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_rosidl_generator_py__msg__Defaults(
  const rosidl_generator_py__msg__Defaults * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_rosidl_generator_py__msg__Defaults(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py__msg__Defaults * ros_message);
...
bool cdr_serialize_key_rosidl_generator_py__msg__Defaults(
  const rosidl_generator_py__msg__Defaults * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_rosidl_generator_py__msg__Defaults(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_rosidl_generator_py__msg__Defaults(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
using _BoundedPlainSequences__ros_msg_type = rosidl_generator_py__msg__BoundedPlainSequences;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
bool cdr_serialize_rosidl_generator_py__msg__BoundedPlainSequences(
  const rosidl_generator_py__msg__BoundedPlainSequences * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: basic_types_values
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rosidl_generator_py__msg__BasicTypes(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: constants_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rosidl_generator_py__msg__Constants(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: defaults_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rosidl_generator_py__msg__Defaults(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
bool cdr_deserialize_rosidl_generator_py__msg__BoundedPlainSequences(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py__msg__BoundedPlainSequences * ros_message)
{
  // Field name: bool_values
  {
    uint32_t cdrSize;
  ...
  // Field name: basic_types_values
  {
    ...
    if (ros_message->basic_types_values.data) {
      rosidl_generator_py__msg__BasicTypes__Sequence__fini(&ros_message->basic_types_values);
    }
    ...
    auto array_ptr = ros_message->basic_types_values.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rosidl_generator_py__msg__BasicTypes(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: constants_values
  {
    ...
    if (ros_message->constants_values.data) {
      rosidl_generator_py__msg__Constants__Sequence__fini(&ros_message->constants_values);
    }
    ...
    auto array_ptr = ros_message->constants_values.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rosidl_generator_py__msg__Constants(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: defaults_values
  {
    ...
    if (ros_message->defaults_values.data) {
      rosidl_generator_py__msg__Defaults__Sequence__fini(&ros_message->defaults_values);
    }
    ...
    auto array_ptr = ros_message->defaults_values.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rosidl_generator_py__msg__Defaults(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
size_t get_serialized_size_rosidl_generator_py__msg__BoundedPlainSequences(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
size_t max_serialized_size_rosidl_generator_py__msg__BoundedPlainSequences(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_generator_py__msg__BoundedPlainSequences;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
bool cdr_serialize_key_rosidl_generator_py__msg__BoundedPlainSequences(
  const rosidl_generator_py__msg__BoundedPlainSequences * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: bool_values
  ...
  // Field name: basic_types_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rosidl_generator_py__msg__BasicTypes(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: constants_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rosidl_generator_py__msg__Constants(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: defaults_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rosidl_generator_py__msg__Defaults(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
size_t get_serialized_size_key_rosidl_generator_py__msg__BoundedPlainSequences(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundedPlainSequences__ros_msg_type * ros_message = static_cast<const _BoundedPlainSequences__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: basic_types_values
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rosidl_generator_py__msg__BasicTypes(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: constants_values
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rosidl_generator_py__msg__Constants(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: defaults_values
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rosidl_generator_py__msg__Defaults(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
size_t max_serialized_size_key_rosidl_generator_py__msg__BoundedPlainSequences(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: basic_types_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rosidl_generator_py__msg__BasicTypes(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: constants_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rosidl_generator_py__msg__Constants(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: defaults_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rosidl_generator_py__msg__Defaults(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rosidl_generator_py__msg__BoundedPlainSequences * ros_message = static_cast<const rosidl_generator_py__msg__BoundedPlainSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rosidl_generator_py__msg__BoundedPlainSequences(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rosidl_generator_py__msg__BoundedPlainSequences * ros_message = static_cast<rosidl_generator_py__msg__BoundedPlainSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rosidl_generator_py__msg__BoundedPlainSequences(cdr, ros_message);
}

static uint32_t _BoundedPlainSequences__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosidl_generator_py__msg__BoundedPlainSequences(
...
static size_t _BoundedPlainSequences__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosidl_generator_py__msg__BoundedPlainSequences(
...
static message_type_support_callbacks_t __callbacks_BoundedPlainSequences = {
...
static rosidl_message_type_support_t _BoundedPlainSequences__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BoundedPlainSequences,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosidl_generator_py, msg, BoundedPlainSequences)() {
  return &_BoundedPlainSequences__type_support;
}
