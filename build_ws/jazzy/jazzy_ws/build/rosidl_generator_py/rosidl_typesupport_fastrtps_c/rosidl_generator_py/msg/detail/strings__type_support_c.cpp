...
#include "rosidl_generator_py/msg/detail/strings__rosidl_typesupport_fastrtps_c.h"
...
bool cdr_serialize_rosidl_generator_py__msg__Strings(
  const rosidl_generator_py__msg__Strings * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
bool cdr_deserialize_rosidl_generator_py__msg__Strings(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py__msg__Strings * ros_message)
{
  // Field name: string_value
  {
    std::string tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_generator_py__msg__Strings;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
bool cdr_serialize_key_rosidl_generator_py__msg__Strings(
  const rosidl_generator_py__msg__Strings * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: string_value
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
size_t get_serialized_size_key_rosidl_generator_py__msg__Strings(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Strings__ros_msg_type * ros_message = static_cast<const _Strings__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosidl_generator_py
size_t max_serialized_size_key_rosidl_generator_py__msg__Strings(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rosidl_generator_py__msg__Strings * ros_message = static_cast<const rosidl_generator_py__msg__Strings *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rosidl_generator_py__msg__Strings(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rosidl_generator_py__msg__Strings * ros_message = static_cast<rosidl_generator_py__msg__Strings *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rosidl_generator_py__msg__Strings(cdr, ros_message);
}
...
static size_t _Strings__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosidl_generator_py__msg__Strings(
