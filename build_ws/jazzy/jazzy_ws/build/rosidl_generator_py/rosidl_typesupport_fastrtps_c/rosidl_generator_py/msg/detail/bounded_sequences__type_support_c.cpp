...
#include "rosidl_generator_py/msg/detail/bounded_sequences__rosidl_typesupport_fastrtps_c.h"
...
using _BoundedSequences__ros_msg_type = rosidl_generator_py__msg__BoundedSequences;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_generator_py__msg__BoundedSequences;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rosidl_generator_py__msg__BoundedSequences * ros_message = static_cast<const rosidl_generator_py__msg__BoundedSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rosidl_generator_py__msg__BoundedSequences(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rosidl_generator_py__msg__BoundedSequences * ros_message = static_cast<rosidl_generator_py__msg__BoundedSequences *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rosidl_generator_py__msg__BoundedSequences(cdr, ros_message);
}

static uint32_t _BoundedSequences__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosidl_generator_py__msg__BoundedSequences(
...
static size_t _BoundedSequences__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosidl_generator_py__msg__BoundedSequences(
