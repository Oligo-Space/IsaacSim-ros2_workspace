...
#include "rosidl_generator_py/msg/detail/arrays__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_generator_py__msg__Arrays;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rosidl_generator_py__msg__Arrays * ros_message = static_cast<const rosidl_generator_py__msg__Arrays *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rosidl_generator_py__msg__Arrays(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rosidl_generator_py__msg__Arrays * ros_message = static_cast<rosidl_generator_py__msg__Arrays *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rosidl_generator_py__msg__Arrays(cdr, ros_message);
}
...
static size_t _Arrays__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosidl_generator_py__msg__Arrays(
