...
#include "rosidl_generator_py/msg/detail/basic_types__rosidl_typesupport_fastrtps_c.h"
...
using _BasicTypes__ros_msg_type = rosidl_generator_py__msg__BasicTypes;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_generator_py__msg__BasicTypes;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rosidl_generator_py__msg__BasicTypes * ros_message = static_cast<const rosidl_generator_py__msg__BasicTypes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rosidl_generator_py__msg__BasicTypes(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rosidl_generator_py__msg__BasicTypes * ros_message = static_cast<rosidl_generator_py__msg__BasicTypes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rosidl_generator_py__msg__BasicTypes(cdr, ros_message);
}

static uint32_t _BasicTypes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosidl_generator_py__msg__BasicTypes(
...
static size_t _BasicTypes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosidl_generator_py__msg__BasicTypes(
...
static message_type_support_callbacks_t __callbacks_BasicTypes = {
...
static rosidl_message_type_support_t _BasicTypes__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BasicTypes,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosidl_generator_py, msg, BasicTypes)() {
  return &_BasicTypes__type_support;
}
