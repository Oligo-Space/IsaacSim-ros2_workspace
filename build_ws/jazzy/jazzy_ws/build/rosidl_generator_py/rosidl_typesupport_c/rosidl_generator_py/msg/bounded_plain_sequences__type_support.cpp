...
static const _BoundedPlainSequences_type_support_symbol_names_t _BoundedPlainSequences_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosidl_generator_py, msg, BoundedPlainSequences)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosidl_generator_py, msg, BoundedPlainSequences)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosidl_generator_py, msg, BoundedPlainSequences)() {
  return &::rosidl_generator_py::msg::rosidl_typesupport_c::BoundedPlainSequences_message_type_support_handle;
}
