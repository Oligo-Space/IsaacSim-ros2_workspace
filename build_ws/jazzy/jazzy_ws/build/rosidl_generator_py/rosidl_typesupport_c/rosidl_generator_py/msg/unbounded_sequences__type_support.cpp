...
static const _UnboundedSequences_type_support_symbol_names_t _UnboundedSequences_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosidl_generator_py, msg, UnboundedSequences)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosidl_generator_py, msg, UnboundedSequences)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosidl_generator_py, msg, UnboundedSequences)() {
  return &::rosidl_generator_py::msg::rosidl_typesupport_c::UnboundedSequences_message_type_support_handle;
}
