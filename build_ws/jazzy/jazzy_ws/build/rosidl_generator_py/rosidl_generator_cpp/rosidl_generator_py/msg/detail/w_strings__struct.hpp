...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__STRUCT_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_generator_py__msg__WStrings __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_py__msg__WStrings __declspec(deprecated)
#endif
...
struct WStrings_
{
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_py::msg::WStrings_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_py::msg::WStrings_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_py::msg::WStrings_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_py__msg__WStrings
    std::shared_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_py__msg__WStrings
    std::shared_ptr<rosidl_generator_py::msg::WStrings_<ContainerAllocator> const>
...
using WStrings =
  rosidl_generator_py::msg::WStrings_<std::allocator<void>>;
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__STRUCT_HPP_
