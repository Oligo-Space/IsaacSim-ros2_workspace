...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__BOUNDED_PLAIN_SEQUENCES__STRUCT_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__BOUNDED_PLAIN_SEQUENCES__STRUCT_HPP_
...
#include "rosidl_generator_py/msg/detail/constants__struct.hpp"
// Member 'defaults_values'
#include "rosidl_generator_py/msg/detail/defaults__struct.hpp"

#ifndef _WIN32
# define DEPRECATED__rosidl_generator_py__msg__BoundedPlainSequences __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_py__msg__BoundedPlainSequences __declspec(deprecated)
#endif
...
struct BoundedPlainSequences_
{
  ...
  using _basic_types_values_type =
    rosidl_runtime_cpp::BoundedVector<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>>>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    rosidl_runtime_cpp::BoundedVector<rosidl_generator_py::msg::Constants_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_generator_py::msg::Constants_<ContainerAllocator>>>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    rosidl_runtime_cpp::BoundedVector<rosidl_generator_py::msg::Defaults_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_generator_py::msg::Defaults_<ContainerAllocator>>>;
  ...
  Type & set__basic_types_values(
    const rosidl_runtime_cpp::BoundedVector<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>>> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const rosidl_runtime_cpp::BoundedVector<rosidl_generator_py::msg::Constants_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_generator_py::msg::Constants_<ContainerAllocator>>> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const rosidl_runtime_cpp::BoundedVector<rosidl_generator_py::msg::Defaults_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_generator_py::msg::Defaults_<ContainerAllocator>>> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_py__msg__BoundedPlainSequences
    std::shared_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_py__msg__BoundedPlainSequences
    std::shared_ptr<rosidl_generator_py::msg::BoundedPlainSequences_<ContainerAllocator> const>
...
using BoundedPlainSequences =
  rosidl_generator_py::msg::BoundedPlainSequences_<std::allocator<void>>;
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__BOUNDED_PLAIN_SEQUENCES__STRUCT_HPP_
