...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__STRINGS__TRAITS_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__STRINGS__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_generator_py::msg::Strings & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_generator_py::msg::Strings & msg)
{
...
template<>
inline const char * name<rosidl_generator_py::msg::Strings>()
{
  return "rosidl_generator_py/msg/Strings";
}
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__STRINGS__TRAITS_HPP_
