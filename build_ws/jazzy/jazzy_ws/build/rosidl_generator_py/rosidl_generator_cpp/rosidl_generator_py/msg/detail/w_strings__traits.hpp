...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__TRAITS_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_generator_py::msg::WStrings & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_generator_py::msg::WStrings & msg)
{
  return rosidl_generator_py::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_generator_py::msg::WStrings>()
{
  return "rosidl_generator_py::msg::WStrings";
}

template<>
inline const char * name<rosidl_generator_py::msg::WStrings>()
{
  return "rosidl_generator_py/msg/WStrings";
}

template<>
struct has_fixed_size<rosidl_generator_py::msg::WStrings>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosidl_generator_py::msg::WStrings>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rosidl_generator_py::msg::WStrings>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__TRAITS_HPP_
