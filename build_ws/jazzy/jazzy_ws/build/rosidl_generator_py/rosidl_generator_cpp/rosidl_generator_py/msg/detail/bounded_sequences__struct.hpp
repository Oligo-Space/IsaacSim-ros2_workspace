...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__BOUNDED_SEQUENCES__STRUCT_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__BOUNDED_SEQUENCES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_generator_py__msg__BoundedSequences __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_py__msg__BoundedSequences __declspec(deprecated)
#endif
...
struct BoundedSequences_
{
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_py__msg__BoundedSequences
    std::shared_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_py__msg__BoundedSequences
    std::shared_ptr<rosidl_generator_py::msg::BoundedSequences_<ContainerAllocator> const>
...
using BoundedSequences =
  rosidl_generator_py::msg::BoundedSequences_<std::allocator<void>>;
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__BOUNDED_SEQUENCES__STRUCT_HPP_
