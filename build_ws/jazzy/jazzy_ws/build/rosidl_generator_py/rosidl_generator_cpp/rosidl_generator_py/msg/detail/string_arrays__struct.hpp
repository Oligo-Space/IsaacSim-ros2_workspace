...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__STRING_ARRAYS__STRUCT_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__STRING_ARRAYS__STRUCT_HPP_
...
struct StringArrays_
{
  ...
  explicit StringArrays_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
    {
      ...
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>(this->ub_string_static_array_value.begin(), this->ub_string_static_array_value.end(), "");
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>(this->string_static_array_value.begin(), this->string_static_array_value.end(), "");
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>(this->def_string_static_array_value.begin(), this->def_string_static_array_value.end(), "");
    }
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
  ...
  explicit StringArrays_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__STRING_ARRAYS__STRUCT_HPP_
