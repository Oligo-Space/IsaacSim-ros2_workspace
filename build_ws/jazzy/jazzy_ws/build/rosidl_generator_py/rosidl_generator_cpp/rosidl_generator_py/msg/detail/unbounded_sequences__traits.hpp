...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__UNBOUNDED_SEQUENCES__TRAITS_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__UNBOUNDED_SEQUENCES__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_generator_py::msg::UnboundedSequences & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_generator_py::msg::UnboundedSequences & msg)
{
  return rosidl_generator_py::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_generator_py::msg::UnboundedSequences>()
{
  return "rosidl_generator_py::msg::UnboundedSequences";
}

template<>
inline const char * name<rosidl_generator_py::msg::UnboundedSequences>()
{
  return "rosidl_generator_py/msg/UnboundedSequences";
}

template<>
struct has_fixed_size<rosidl_generator_py::msg::UnboundedSequences>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosidl_generator_py::msg::UnboundedSequences>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rosidl_generator_py::msg::UnboundedSequences>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__UNBOUNDED_SEQUENCES__TRAITS_HPP_
