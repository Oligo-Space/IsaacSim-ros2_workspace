...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__ARRAYS__STRUCT_HPP_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__ARRAYS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_generator_py__msg__Arrays __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_py__msg__Arrays __declspec(deprecated)
#endif
...
struct Arrays_
{
  ...
  explicit Arrays_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint64_t, 3>::iterator, uint64_t>(this->uint64_values.begin(), this->uint64_values.end(), 0ull);
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>(this->string_values.begin(), this->string_values.end(), "");
      this->basic_types_values.fill(rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>{_init});
      this->constants_values.fill(rosidl_generator_py::msg::Constants_<ContainerAllocator>{_init});
      this->defaults_values.fill(rosidl_generator_py::msg::Defaults_<ContainerAllocator>{_init});
      this->alignment_check = 0l;
    }
  }
    ...
    string_values_default(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint64_t, 3>::iterator, uint64_t>(this->uint64_values.begin(), this->uint64_values.end(), 0ull);
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>(this->string_values.begin(), this->string_values.end(), "");
      this->basic_types_values.fill(rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>{_alloc, _init});
      this->constants_values.fill(rosidl_generator_py::msg::Constants_<ContainerAllocator>{_alloc, _init});
      this->defaults_values.fill(rosidl_generator_py::msg::Defaults_<ContainerAllocator>{_alloc, _init});
      this->alignment_check = 0l;
    }
  }
  ...
  using _basic_types_values_type =
    std::array<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>, 3>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    std::array<rosidl_generator_py::msg::Constants_<ContainerAllocator>, 3>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    std::array<rosidl_generator_py::msg::Defaults_<ContainerAllocator>, 3>;
  ...
  Type & set__basic_types_values(
    const std::array<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>, 3> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const std::array<rosidl_generator_py::msg::Constants_<ContainerAllocator>, 3> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const std::array<rosidl_generator_py::msg::Defaults_<ContainerAllocator>, 3> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_py::msg::Arrays_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_py::msg::Arrays_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_py::msg::Arrays_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_py__msg__Arrays
    std::shared_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_py__msg__Arrays
    std::shared_ptr<rosidl_generator_py::msg::Arrays_<ContainerAllocator> const>
...
using Arrays =
  rosidl_generator_py::msg::Arrays_<std::allocator<void>>;
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__ARRAYS__STRUCT_HPP_
