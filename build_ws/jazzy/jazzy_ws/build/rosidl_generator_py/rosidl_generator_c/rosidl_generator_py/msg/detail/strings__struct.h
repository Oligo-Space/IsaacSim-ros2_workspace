...
// IWYU pragma: private, include "rosidl_generator_py/msg/strings.h"


#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__STRINGS__STRUCT_H_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__STRINGS__STRUCT_H_
...
static const char * const rosidl_generator_py__msg__Strings__STRING_CONST = "Hello world!";
...
enum
{
  rosidl_generator_py__msg__Strings__bounded_string_value__MAX_STRING_SIZE = 22
};
// bounded_string_value_default1
enum
{
  rosidl_generator_py__msg__Strings__bounded_string_value_default1__MAX_STRING_SIZE = 22
};
// bounded_string_value_default2
enum
{
  rosidl_generator_py__msg__Strings__bounded_string_value_default2__MAX_STRING_SIZE = 22
};
// bounded_string_value_default3
enum
{
  rosidl_generator_py__msg__Strings__bounded_string_value_default3__MAX_STRING_SIZE = 22
};
// bounded_string_value_default4
enum
{
  rosidl_generator_py__msg__Strings__bounded_string_value_default4__MAX_STRING_SIZE = 22
};
// bounded_string_value_default5
enum
{
  rosidl_generator_py__msg__Strings__bounded_string_value_default5__MAX_STRING_SIZE = 22
};

/// Struct defined in msg/Strings in the package rosidl_generator_py.
typedef struct rosidl_generator_py__msg__Strings
{
...
// Struct for a sequence of rosidl_generator_py__msg__Strings.
typedef struct rosidl_generator_py__msg__Strings__Sequence
{
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__STRINGS__STRUCT_H_
