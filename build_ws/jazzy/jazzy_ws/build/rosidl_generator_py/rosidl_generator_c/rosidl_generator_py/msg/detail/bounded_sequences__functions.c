...
rosidl_generator_py__msg__BoundedSequences__init(rosidl_generator_py__msg__BoundedSequences * msg)
{
  ...
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->bool_values, 0)) {
    rosidl_generator_py__msg__BoundedSequences__fini(msg);
    return false;
  }
  // byte_values
...
rosidl_generator_py__msg__BoundedSequences__create(void)
{
  ...
  rosidl_generator_py__msg__BoundedSequences * msg = (rosidl_generator_py__msg__BoundedSequences *)allocator.allocate(sizeof(rosidl_generator_py__msg__BoundedSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_py__msg__BoundedSequences));
  bool success = rosidl_generator_py__msg__BoundedSequences__init(msg);
  if (!success) {
...
rosidl_generator_py__msg__BoundedSequences__Sequence__init(rosidl_generator_py__msg__BoundedSequences__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BoundedSequences * data = NULL;

  if (size) {
    data = (rosidl_generator_py__msg__BoundedSequences *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__BoundedSequences), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_py__msg__BoundedSequences__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_py__msg__BoundedSequences__fini(&data[i - 1]);
      }
...
rosidl_generator_py__msg__BoundedSequences__Sequence__fini(rosidl_generator_py__msg__BoundedSequences__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_py__msg__BoundedSequences__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BoundedSequences__Sequence * array = (rosidl_generator_py__msg__BoundedSequences__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__BoundedSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_py__msg__BoundedSequences__Sequence__init(array, size);
  if (!success) {
...
rosidl_generator_py__msg__BoundedSequences__Sequence__destroy(rosidl_generator_py__msg__BoundedSequences__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_generator_py__msg__BoundedSequences__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosidl_generator_py__msg__BoundedSequences__Sequence__are_equal(const rosidl_generator_py__msg__BoundedSequences__Sequence * lhs, const rosidl_generator_py__msg__BoundedSequences__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__BoundedSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosidl_generator_py__msg__BoundedSequences__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__BoundedSequences);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__BoundedSequences * data =
      (rosidl_generator_py__msg__BoundedSequences *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__BoundedSequences__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__BoundedSequences__fini(&output->data[i]);
        }
        return false;
      }
    }
