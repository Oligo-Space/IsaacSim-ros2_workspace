...
bool
rosidl_generator_py__msg__UnboundedSequences__init(rosidl_generator_py__msg__UnboundedSequences * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->bool_values, 0)) {
    rosidl_generator_py__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // byte_values
...
void
rosidl_generator_py__msg__UnboundedSequences__fini(rosidl_generator_py__msg__UnboundedSequences * msg)
{
  if (!msg) {
    return;
  }
...
bool
rosidl_generator_py__msg__UnboundedSequences__are_equal(const rosidl_generator_py__msg__UnboundedSequences * lhs, const rosidl_generator_py__msg__UnboundedSequences * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosidl_generator_py__msg__UnboundedSequences__copy(
  const rosidl_generator_py__msg__UnboundedSequences * input,
  rosidl_generator_py__msg__UnboundedSequences * output)
{
  if (!input || !output) {
    return false;
  }
...
rosidl_generator_py__msg__UnboundedSequences__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__UnboundedSequences * msg = (rosidl_generator_py__msg__UnboundedSequences *)allocator.allocate(sizeof(rosidl_generator_py__msg__UnboundedSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_py__msg__UnboundedSequences));
  bool success = rosidl_generator_py__msg__UnboundedSequences__init(msg);
  if (!success) {
...
void
rosidl_generator_py__msg__UnboundedSequences__destroy(rosidl_generator_py__msg__UnboundedSequences * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosidl_generator_py__msg__UnboundedSequences__fini(msg);
...
bool
rosidl_generator_py__msg__UnboundedSequences__Sequence__init(rosidl_generator_py__msg__UnboundedSequences__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__UnboundedSequences * data = NULL;

  if (size) {
    data = (rosidl_generator_py__msg__UnboundedSequences *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__UnboundedSequences), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_py__msg__UnboundedSequences__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_py__msg__UnboundedSequences__fini(&data[i - 1]);
      }
...
void
rosidl_generator_py__msg__UnboundedSequences__Sequence__fini(rosidl_generator_py__msg__UnboundedSequences__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_py__msg__UnboundedSequences__fini(&array->data[i]);
    }
...
rosidl_generator_py__msg__UnboundedSequences__Sequence *
rosidl_generator_py__msg__UnboundedSequences__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__UnboundedSequences__Sequence * array = (rosidl_generator_py__msg__UnboundedSequences__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__UnboundedSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_py__msg__UnboundedSequences__Sequence__init(array, size);
  if (!success) {
...
void
rosidl_generator_py__msg__UnboundedSequences__Sequence__destroy(rosidl_generator_py__msg__UnboundedSequences__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_generator_py__msg__UnboundedSequences__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rosidl_generator_py__msg__UnboundedSequences__Sequence__are_equal(const rosidl_generator_py__msg__UnboundedSequences__Sequence * lhs, const rosidl_generator_py__msg__UnboundedSequences__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__UnboundedSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_generator_py__msg__UnboundedSequences__Sequence__copy(
  const rosidl_generator_py__msg__UnboundedSequences__Sequence * input,
  rosidl_generator_py__msg__UnboundedSequences__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__UnboundedSequences);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__UnboundedSequences * data =
      (rosidl_generator_py__msg__UnboundedSequences *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__UnboundedSequences__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__UnboundedSequences__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosidl_generator_py__msg__UnboundedSequences__copy(
