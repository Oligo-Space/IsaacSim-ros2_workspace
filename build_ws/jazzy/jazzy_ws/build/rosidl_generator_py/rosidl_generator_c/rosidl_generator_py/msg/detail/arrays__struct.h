...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__ARRAYS__STRUCT_H_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__ARRAYS__STRUCT_H_
...
/// Struct defined in msg/Arrays in the package rosidl_generator_py.
/**
  * Arrays of different types
 */
typedef struct rosidl_generator_py__msg__Arrays
{
  bool bool_values[3];
  ...
  rosidl_generator_py__msg__BasicTypes basic_types_values[3];
  rosidl_generator_py__msg__Constants constants_values[3];
  rosidl_generator_py__msg__Defaults defaults_values[3];
...
// Struct for a sequence of rosidl_generator_py__msg__Arrays.
typedef struct rosidl_generator_py__msg__Arrays__Sequence
{
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__ARRAYS__STRUCT_H_
