...
// IWYU pragma: private, include "rosidl_generator_py/msg/string_arrays.h"


#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__STRING_ARRAYS__STRUCT_H_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__STRING_ARRAYS__STRUCT_H_
...
{
  rosidl_runtime_c__String ub_string_static_array_value[3];
  rosidl_runtime_c__String__Sequence ub_string_ub_array_value;
  rosidl_runtime_c__String__Sequence ub_string_dynamic_array_value;
  rosidl_runtime_c__String__Sequence string_dynamic_array_value;
  rosidl_runtime_c__String string_static_array_value[3];
  rosidl_runtime_c__String__Sequence string_bounded_array_value;
  rosidl_runtime_c__String__Sequence def_string_dynamic_array_value;
  rosidl_runtime_c__String def_string_static_array_value[3];
  rosidl_runtime_c__String__Sequence def_string_bounded_array_value;
  rosidl_runtime_c__String__Sequence def_various_quotes;
  rosidl_runtime_c__String__Sequence def_various_commas;
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__STRING_ARRAYS__STRUCT_H_
