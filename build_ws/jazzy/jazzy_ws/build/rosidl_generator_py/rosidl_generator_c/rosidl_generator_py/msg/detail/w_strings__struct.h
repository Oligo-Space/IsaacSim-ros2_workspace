...
#ifndef ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__STRUCT_H_
#define ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__STRUCT_H_
...
enum
{
  rosidl_generator_py__msg__WStrings__bounded_sequence_of_wstrings__MAX_SIZE = 3
};

/// Struct defined in msg/WStrings in the package rosidl_generator_py.
typedef struct rosidl_generator_py__msg__WStrings
{
...
// Struct for a sequence of rosidl_generator_py__msg__WStrings.
typedef struct rosidl_generator_py__msg__WStrings__Sequence
{
...
#endif  // ROSIDL_GENERATOR_PY__MSG__DETAIL__W_STRINGS__STRUCT_H_
