...
bool
rosidl_generator_py__msg__Nested__are_equal(const rosidl_generator_py__msg__Nested * lhs, const rosidl_generator_py__msg__Nested * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosidl_generator_py__msg__Nested__copy(
  const rosidl_generator_py__msg__Nested * input,
  rosidl_generator_py__msg__Nested * output)
{
  if (!input || !output) {
    return false;
  }
...
rosidl_generator_py__msg__Nested__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Nested * msg = (rosidl_generator_py__msg__Nested *)allocator.allocate(sizeof(rosidl_generator_py__msg__Nested), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_py__msg__Nested__Sequence__init(rosidl_generator_py__msg__Nested__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_py__msg__Nested *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__Nested), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Nested__Sequence * array = (rosidl_generator_py__msg__Nested__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__Nested__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rosidl_generator_py__msg__Nested__Sequence__are_equal(const rosidl_generator_py__msg__Nested__Sequence * lhs, const rosidl_generator_py__msg__Nested__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__Nested__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_generator_py__msg__Nested__Sequence__copy(
  const rosidl_generator_py__msg__Nested__Sequence * input,
  rosidl_generator_py__msg__Nested__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__Nested);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__Nested * data =
      (rosidl_generator_py__msg__Nested *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__Nested__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__Nested__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosidl_generator_py__msg__Nested__copy(
