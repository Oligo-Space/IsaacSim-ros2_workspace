...
rosidl_generator_py__msg__Strings__init(rosidl_generator_py__msg__Strings * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->string_value)) {
    rosidl_generator_py__msg__Strings__fini(msg);
    return false;
  }
...
bool
rosidl_generator_py__msg__Strings__are_equal(const rosidl_generator_py__msg__Strings * lhs, const rosidl_generator_py__msg__Strings * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosidl_generator_py__msg__Strings__copy(
  const rosidl_generator_py__msg__Strings * input,
  rosidl_generator_py__msg__Strings * output)
{
  if (!input || !output) {
    return false;
  }
...
rosidl_generator_py__msg__Strings__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Strings * msg = (rosidl_generator_py__msg__Strings *)allocator.allocate(sizeof(rosidl_generator_py__msg__Strings), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_py__msg__Strings));
  bool success = rosidl_generator_py__msg__Strings__init(msg);
  if (!success) {
...
rosidl_generator_py__msg__Strings__Sequence__init(rosidl_generator_py__msg__Strings__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Strings * data = NULL;

  if (size) {
    data = (rosidl_generator_py__msg__Strings *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__Strings), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_py__msg__Strings__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_py__msg__Strings__fini(&data[i - 1]);
      }
...
rosidl_generator_py__msg__Strings__Sequence__fini(rosidl_generator_py__msg__Strings__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_py__msg__Strings__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Strings__Sequence * array = (rosidl_generator_py__msg__Strings__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__Strings__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_py__msg__Strings__Sequence__init(array, size);
  if (!success) {
...
rosidl_generator_py__msg__Strings__Sequence__destroy(rosidl_generator_py__msg__Strings__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_generator_py__msg__Strings__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rosidl_generator_py__msg__Strings__Sequence__are_equal(const rosidl_generator_py__msg__Strings__Sequence * lhs, const rosidl_generator_py__msg__Strings__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__Strings__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_generator_py__msg__Strings__Sequence__copy(
  const rosidl_generator_py__msg__Strings__Sequence * input,
  rosidl_generator_py__msg__Strings__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__Strings);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__Strings * data =
      (rosidl_generator_py__msg__Strings *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__Strings__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__Strings__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosidl_generator_py__msg__Strings__copy(
