...
bool
rosidl_generator_py__msg__BoundedPlainSequences__init(rosidl_generator_py__msg__BoundedPlainSequences * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->bool_values, 0)) {
    rosidl_generator_py__msg__BoundedPlainSequences__fini(msg);
    return false;
  }
  // byte_values
  ...
  // basic_types_values
  if (!rosidl_generator_py__msg__BasicTypes__Sequence__init(&msg->basic_types_values, 0)) {
    rosidl_generator_py__msg__BoundedPlainSequences__fini(msg);
    return false;
  }
  // constants_values
  if (!rosidl_generator_py__msg__Constants__Sequence__init(&msg->constants_values, 0)) {
    rosidl_generator_py__msg__BoundedPlainSequences__fini(msg);
    return false;
  }
  // defaults_values
  if (!rosidl_generator_py__msg__Defaults__Sequence__init(&msg->defaults_values, 0)) {
    rosidl_generator_py__msg__BoundedPlainSequences__fini(msg);
    return false;
  }
  // bool_values_default
...
void
rosidl_generator_py__msg__BoundedPlainSequences__fini(rosidl_generator_py__msg__BoundedPlainSequences * msg)
{
  if (!msg) {
    return;
  }
  ...
  // basic_types_values
  rosidl_generator_py__msg__BasicTypes__Sequence__fini(&msg->basic_types_values);
  // constants_values
  rosidl_generator_py__msg__Constants__Sequence__fini(&msg->constants_values);
  // defaults_values
  rosidl_generator_py__msg__Defaults__Sequence__fini(&msg->defaults_values);
  // bool_values_default
  rosidl_runtime_c__boolean__Sequence__fini(&msg->bool_values_default);
  // byte_values_default
  rosidl_runtime_c__octet__Sequence__fini(&msg->byte_values_default);
...
bool
rosidl_generator_py__msg__BoundedPlainSequences__are_equal(const rosidl_generator_py__msg__BoundedPlainSequences * lhs, const rosidl_generator_py__msg__BoundedPlainSequences * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // basic_types_values
  if (!rosidl_generator_py__msg__BasicTypes__Sequence__are_equal(
      &(lhs->basic_types_values), &(rhs->basic_types_values)))
  {
    return false;
  }
  // constants_values
  if (!rosidl_generator_py__msg__Constants__Sequence__are_equal(
      &(lhs->constants_values), &(rhs->constants_values)))
  {
    return false;
  }
  // defaults_values
  if (!rosidl_generator_py__msg__Defaults__Sequence__are_equal(
...
bool
rosidl_generator_py__msg__BoundedPlainSequences__copy(
  const rosidl_generator_py__msg__BoundedPlainSequences * input,
  rosidl_generator_py__msg__BoundedPlainSequences * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // basic_types_values
  if (!rosidl_generator_py__msg__BasicTypes__Sequence__copy(
      &(input->basic_types_values), &(output->basic_types_values)))
  {
    return false;
  }
  // constants_values
  if (!rosidl_generator_py__msg__Constants__Sequence__copy(
      &(input->constants_values), &(output->constants_values)))
  {
    return false;
  }
  // defaults_values
  if (!rosidl_generator_py__msg__Defaults__Sequence__copy(
...
rosidl_generator_py__msg__BoundedPlainSequences *
rosidl_generator_py__msg__BoundedPlainSequences__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BoundedPlainSequences * msg = (rosidl_generator_py__msg__BoundedPlainSequences *)allocator.allocate(sizeof(rosidl_generator_py__msg__BoundedPlainSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_py__msg__BoundedPlainSequences));
  bool success = rosidl_generator_py__msg__BoundedPlainSequences__init(msg);
  if (!success) {
...
void
rosidl_generator_py__msg__BoundedPlainSequences__destroy(rosidl_generator_py__msg__BoundedPlainSequences * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosidl_generator_py__msg__BoundedPlainSequences__fini(msg);
...
bool
rosidl_generator_py__msg__BoundedPlainSequences__Sequence__init(rosidl_generator_py__msg__BoundedPlainSequences__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BoundedPlainSequences * data = NULL;

  if (size) {
    data = (rosidl_generator_py__msg__BoundedPlainSequences *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__BoundedPlainSequences), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_py__msg__BoundedPlainSequences__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_py__msg__BoundedPlainSequences__fini(&data[i - 1]);
      }
...
void
rosidl_generator_py__msg__BoundedPlainSequences__Sequence__fini(rosidl_generator_py__msg__BoundedPlainSequences__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_py__msg__BoundedPlainSequences__fini(&array->data[i]);
    }
...
rosidl_generator_py__msg__BoundedPlainSequences__Sequence *
rosidl_generator_py__msg__BoundedPlainSequences__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BoundedPlainSequences__Sequence * array = (rosidl_generator_py__msg__BoundedPlainSequences__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__BoundedPlainSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_py__msg__BoundedPlainSequences__Sequence__init(array, size);
  if (!success) {
...
void
rosidl_generator_py__msg__BoundedPlainSequences__Sequence__destroy(rosidl_generator_py__msg__BoundedPlainSequences__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_generator_py__msg__BoundedPlainSequences__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rosidl_generator_py__msg__BoundedPlainSequences__Sequence__are_equal(const rosidl_generator_py__msg__BoundedPlainSequences__Sequence * lhs, const rosidl_generator_py__msg__BoundedPlainSequences__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__BoundedPlainSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_generator_py__msg__BoundedPlainSequences__Sequence__copy(
  const rosidl_generator_py__msg__BoundedPlainSequences__Sequence * input,
  rosidl_generator_py__msg__BoundedPlainSequences__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__BoundedPlainSequences);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__BoundedPlainSequences * data =
      (rosidl_generator_py__msg__BoundedPlainSequences *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__BoundedPlainSequences__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__BoundedPlainSequences__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosidl_generator_py__msg__BoundedPlainSequences__copy(
