...
rosidl_generator_py__msg__Arrays__init(rosidl_generator_py__msg__Arrays * msg)
{
  ...
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_runtime_c__String__init(&msg->string_values[i])) {
      rosidl_generator_py__msg__Arrays__fini(msg);
      return false;
    }
  }
  // basic_types_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__BasicTypes__init(&msg->basic_types_values[i])) {
      rosidl_generator_py__msg__Arrays__fini(msg);
      return false;
    }
  }
  // constants_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__Constants__init(&msg->constants_values[i])) {
      rosidl_generator_py__msg__Arrays__fini(msg);
      return false;
    }
  }
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__Defaults__init(&msg->defaults_values[i])) {
      rosidl_generator_py__msg__Arrays__fini(msg);
      return false;
    }
  }
...
rosidl_generator_py__msg__Arrays__fini(rosidl_generator_py__msg__Arrays * msg)
{
  ...
  // basic_types_values
  for (size_t i = 0; i < 3; ++i) {
    rosidl_generator_py__msg__BasicTypes__fini(&msg->basic_types_values[i]);
  }
  // constants_values
  for (size_t i = 0; i < 3; ++i) {
    rosidl_generator_py__msg__Constants__fini(&msg->constants_values[i]);
  }
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    rosidl_generator_py__msg__Defaults__fini(&msg->defaults_values[i]);
  }
  // bool_values_default
  // byte_values_default
  // char_values_default
...
rosidl_generator_py__msg__Arrays__are_equal(const rosidl_generator_py__msg__Arrays * lhs, const rosidl_generator_py__msg__Arrays * rhs)
{
  ...
  // basic_types_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__BasicTypes__are_equal(
  ...
  // constants_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__Constants__are_equal(
  ...
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__Defaults__are_equal(
  ...
  rosidl_generator_py__msg__Arrays * output)
{
  ...
  // basic_types_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_py__msg__BasicTypes__copy(
...
rosidl_generator_py__msg__Arrays__create(void)
{
  ...
  rosidl_generator_py__msg__Arrays * msg = (rosidl_generator_py__msg__Arrays *)allocator.allocate(sizeof(rosidl_generator_py__msg__Arrays), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_py__msg__Arrays));
  bool success = rosidl_generator_py__msg__Arrays__init(msg);
  if (!success) {
...
rosidl_generator_py__msg__Arrays__Sequence__init(rosidl_generator_py__msg__Arrays__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Arrays * data = NULL;

  if (size) {
    data = (rosidl_generator_py__msg__Arrays *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__Arrays), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_py__msg__Arrays__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_py__msg__Arrays__fini(&data[i - 1]);
      }
...
rosidl_generator_py__msg__Arrays__Sequence__fini(rosidl_generator_py__msg__Arrays__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_py__msg__Arrays__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__Arrays__Sequence * array = (rosidl_generator_py__msg__Arrays__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__Arrays__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_py__msg__Arrays__Sequence__init(array, size);
  if (!success) {
...
rosidl_generator_py__msg__Arrays__Sequence__destroy(rosidl_generator_py__msg__Arrays__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_generator_py__msg__Arrays__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosidl_generator_py__msg__Arrays__Sequence__are_equal(const rosidl_generator_py__msg__Arrays__Sequence * lhs, const rosidl_generator_py__msg__Arrays__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__Arrays__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosidl_generator_py__msg__Arrays__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__Arrays);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__Arrays * data =
      (rosidl_generator_py__msg__Arrays *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__Arrays__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__Arrays__fini(&output->data[i]);
        }
        return false;
      }
    }
