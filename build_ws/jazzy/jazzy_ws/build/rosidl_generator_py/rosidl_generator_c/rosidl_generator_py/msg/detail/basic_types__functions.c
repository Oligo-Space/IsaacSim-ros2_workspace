...
bool
rosidl_generator_py__msg__BasicTypes__are_equal(const rosidl_generator_py__msg__BasicTypes * lhs, const rosidl_generator_py__msg__BasicTypes * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosidl_generator_py__msg__BasicTypes__copy(
  const rosidl_generator_py__msg__BasicTypes * input,
  rosidl_generator_py__msg__BasicTypes * output)
{
  if (!input || !output) {
    return false;
  }
...
rosidl_generator_py__msg__BasicTypes__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BasicTypes * msg = (rosidl_generator_py__msg__BasicTypes *)allocator.allocate(sizeof(rosidl_generator_py__msg__BasicTypes), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_py__msg__BasicTypes__Sequence__init(rosidl_generator_py__msg__BasicTypes__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_py__msg__BasicTypes *)allocator.zero_allocate(size, sizeof(rosidl_generator_py__msg__BasicTypes), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_py__msg__BasicTypes__Sequence * array = (rosidl_generator_py__msg__BasicTypes__Sequence *)allocator.allocate(sizeof(rosidl_generator_py__msg__BasicTypes__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rosidl_generator_py__msg__BasicTypes__Sequence__are_equal(const rosidl_generator_py__msg__BasicTypes__Sequence * lhs, const rosidl_generator_py__msg__BasicTypes__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_py__msg__BasicTypes__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_generator_py__msg__BasicTypes__Sequence__copy(
  const rosidl_generator_py__msg__BasicTypes__Sequence * input,
  rosidl_generator_py__msg__BasicTypes__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_py__msg__BasicTypes);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_py__msg__BasicTypes * data =
      (rosidl_generator_py__msg__BasicTypes *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__BasicTypes__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__BasicTypes__fini(&output->data[i]);
        }
        return false;
      }
    }
