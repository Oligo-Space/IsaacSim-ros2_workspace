  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__msg__ParameterEvent * ros_message = static_cast<const rcl_interfaces__msg__ParameterEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__msg__ParameterEvent(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__msg__ParameterEvent * ros_message = static_cast<rcl_interfaces__msg__ParameterEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__msg__ParameterEvent(cdr, ros_message);
}
