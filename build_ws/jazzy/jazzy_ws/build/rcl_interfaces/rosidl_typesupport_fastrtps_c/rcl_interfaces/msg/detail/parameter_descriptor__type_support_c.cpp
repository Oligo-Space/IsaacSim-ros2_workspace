  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: floating_point_range
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__msg__FloatingPointRange(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: integer_range
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__msg__IntegerRange(
        &array_ptr[i], cdr);
    }
  }
  ...
  rcl_interfaces__msg__ParameterDescriptor * ros_message)
{
  ...
  // Field name: floating_point_range
  {
    ...
    auto array_ptr = ros_message->floating_point_range.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__msg__FloatingPointRange(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: integer_range
  {
    ...
    auto array_ptr = ros_message->integer_range.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__msg__IntegerRange(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: floating_point_range
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__msg__FloatingPointRange(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: integer_range
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__msg__IntegerRange(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: floating_point_range
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__msg__FloatingPointRange(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: integer_range
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__msg__IntegerRange(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: floating_point_range
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__msg__FloatingPointRange(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: integer_range
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__msg__IntegerRange(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__msg__ParameterDescriptor * ros_message = static_cast<const rcl_interfaces__msg__ParameterDescriptor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__msg__ParameterDescriptor(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__msg__ParameterDescriptor * ros_message = static_cast<rcl_interfaces__msg__ParameterDescriptor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__msg__ParameterDescriptor(cdr, ros_message);
}
