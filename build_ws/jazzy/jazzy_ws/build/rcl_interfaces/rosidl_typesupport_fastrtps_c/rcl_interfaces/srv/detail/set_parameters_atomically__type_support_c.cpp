  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__SetParametersAtomically_Request * ros_message = static_cast<const rcl_interfaces__srv__SetParametersAtomically_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__SetParametersAtomically_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__SetParametersAtomically_Request * ros_message = static_cast<rcl_interfaces__srv__SetParametersAtomically_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__SetParametersAtomically_Request(cdr, ros_message);
}
  ...
  rcl_interfaces__srv__SetParametersAtomically_Response * ros_message)
{
  // Field name: result
  {
    cdr_deserialize_rcl_interfaces__msg__SetParametersResult(cdr, &ros_message->result);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__SetParametersAtomically_Response * ros_message = static_cast<const rcl_interfaces__srv__SetParametersAtomically_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__SetParametersAtomically_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__SetParametersAtomically_Response * ros_message = static_cast<rcl_interfaces__srv__SetParametersAtomically_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__SetParametersAtomically_Response(cdr, ros_message);
}
...
using _SetParametersAtomically_Event__ros_msg_type = rcl_interfaces__srv__SetParametersAtomically_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__srv__SetParametersAtomically_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__srv__SetParametersAtomically_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  rcl_interfaces__srv__SetParametersAtomically_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__srv__SetParametersAtomically_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__srv__SetParametersAtomically_Response(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Event(
  ...
  size_t current_alignment)
{
  const _SetParametersAtomically_Event__ros_msg_type * ros_message = static_cast<const _SetParametersAtomically_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rcl_interfaces__srv__SetParametersAtomically_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__srv__SetParametersAtomically_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__srv__SetParametersAtomically_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__srv__SetParametersAtomically_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__srv__SetParametersAtomically_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__srv__SetParametersAtomically_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__srv__SetParametersAtomically_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _SetParametersAtomically_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const rcl_interfaces__srv__SetParametersAtomically_Event * ros_message = static_cast<const rcl_interfaces__srv__SetParametersAtomically_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__SetParametersAtomically_Event(ros_message, cdr);
}

static bool _SetParametersAtomically_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  rcl_interfaces__srv__SetParametersAtomically_Event * ros_message = static_cast<rcl_interfaces__srv__SetParametersAtomically_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__SetParametersAtomically_Event(cdr, ros_message);
}

static uint32_t _SetParametersAtomically_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Event(
      untyped_ros_message, 0));
}

static size_t _SetParametersAtomically_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_SetParametersAtomically_Event = {
  "rcl_interfaces::srv",
  "SetParametersAtomically_Event",
  _SetParametersAtomically_Event__cdr_serialize,
  _SetParametersAtomically_Event__cdr_deserialize,
  _SetParametersAtomically_Event__get_serialized_size,
  _SetParametersAtomically_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _SetParametersAtomically_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SetParametersAtomically_Event,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rcl_interfaces, srv, SetParametersAtomically_Event)() {
  return &_SetParametersAtomically_Event__type_support;
}
...
static rosidl_service_type_support_t SetParametersAtomically__handle = {
  ...
  &_SetParametersAtomically_Request__type_support,
  &_SetParametersAtomically_Response__type_support,
  &_SetParametersAtomically_Event__type_support,
