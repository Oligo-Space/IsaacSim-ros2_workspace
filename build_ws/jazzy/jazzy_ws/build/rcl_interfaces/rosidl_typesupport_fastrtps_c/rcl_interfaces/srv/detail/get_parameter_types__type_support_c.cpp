  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__GetParameterTypes_Request * ros_message = static_cast<const rcl_interfaces__srv__GetParameterTypes_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__GetParameterTypes_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__GetParameterTypes_Request * ros_message = static_cast<rcl_interfaces__srv__GetParameterTypes_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__GetParameterTypes_Request(cdr, ros_message);
}
...
static size_t _GetParameterTypes_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Request(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__GetParameterTypes_Response * ros_message = static_cast<const rcl_interfaces__srv__GetParameterTypes_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__GetParameterTypes_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__GetParameterTypes_Response * ros_message = static_cast<rcl_interfaces__srv__GetParameterTypes_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__GetParameterTypes_Response(cdr, ros_message);
}
...
static size_t _GetParameterTypes_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Response(
    full_bounded, is_plain, 0);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__srv__GetParameterTypes_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__srv__GetParameterTypes_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  rcl_interfaces__srv__GetParameterTypes_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__srv__GetParameterTypes_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__srv__GetParameterTypes_Response(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rcl_interfaces__srv__GetParameterTypes_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rcl_interfaces__srv__GetParameterTypes_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__srv__GetParameterTypes_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__srv__GetParameterTypes_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__srv__GetParameterTypes_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__srv__GetParameterTypes_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__srv__GetParameterTypes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__srv__GetParameterTypes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__GetParameterTypes_Event * ros_message = static_cast<const rcl_interfaces__srv__GetParameterTypes_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__GetParameterTypes_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__GetParameterTypes_Event * ros_message = static_cast<rcl_interfaces__srv__GetParameterTypes_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__GetParameterTypes_Event(cdr, ros_message);
}

static uint32_t _GetParameterTypes_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rcl_interfaces__srv__GetParameterTypes_Event(
      untyped_ros_message, 0));
}
...
static size_t _GetParameterTypes_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_GetParameterTypes_Event = {
  "rcl_interfaces::srv",
...
static rosidl_message_type_support_t _GetParameterTypes_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GetParameterTypes_Event,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rcl_interfaces, srv, GetParameterTypes_Event)() {
  return &_GetParameterTypes_Event__type_support;
}
...
static rosidl_service_type_support_t GetParameterTypes__handle = {
  ...
  &_GetParameterTypes_Request__type_support,
  &_GetParameterTypes_Response__type_support,
  &_GetParameterTypes_Event__type_support,
