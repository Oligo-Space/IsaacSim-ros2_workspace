  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__GetParameters_Request * ros_message = static_cast<const rcl_interfaces__srv__GetParameters_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__GetParameters_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__GetParameters_Request * ros_message = static_cast<rcl_interfaces__srv__GetParameters_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__GetParameters_Request(cdr, ros_message);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__msg__ParameterValue(
        &array_ptr[i], cdr);
    }
  }
  ...
  rcl_interfaces__srv__GetParameters_Response * ros_message)
{
  // Field name: values
  {
    ...
    auto array_ptr = ros_message->values.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__msg__ParameterValue(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__msg__ParameterValue(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: values
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__msg__ParameterValue(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__msg__ParameterValue(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__GetParameters_Response * ros_message = static_cast<const rcl_interfaces__srv__GetParameters_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__GetParameters_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__GetParameters_Response * ros_message = static_cast<rcl_interfaces__srv__GetParameters_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__GetParameters_Response(cdr, ros_message);
}
...
using _GetParameters_Event__ros_msg_type = rcl_interfaces__srv__GetParameters_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__srv__GetParameters_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rcl_interfaces__srv__GetParameters_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  rcl_interfaces__srv__GetParameters_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      rcl_interfaces__srv__GetParameters_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__srv__GetParameters_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      rcl_interfaces__srv__GetParameters_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rcl_interfaces__srv__GetParameters_Response(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rcl_interfaces__srv__GetParameters_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rcl_interfaces__srv__GetParameters_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rcl_interfaces__srv__GetParameters_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rcl_interfaces__srv__GetParameters_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rcl_interfaces__srv__GetParameters_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__srv__GetParameters_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rcl_interfaces__srv__GetParameters_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__srv__GetParameters_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rcl_interfaces__srv__GetParameters_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__srv__GetParameters_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rcl_interfaces__srv__GetParameters_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rcl_interfaces__srv__GetParameters_Event * ros_message = static_cast<const rcl_interfaces__srv__GetParameters_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rcl_interfaces__srv__GetParameters_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rcl_interfaces__srv__GetParameters_Event * ros_message = static_cast<rcl_interfaces__srv__GetParameters_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rcl_interfaces__srv__GetParameters_Event(cdr, ros_message);
}
...
static size_t _GetParameters_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rcl_interfaces__srv__GetParameters_Event(
    full_bounded, is_plain, 0);
