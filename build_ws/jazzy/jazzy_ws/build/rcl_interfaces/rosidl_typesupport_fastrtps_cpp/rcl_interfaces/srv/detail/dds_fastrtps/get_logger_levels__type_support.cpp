...
#include "rcl_interfaces/srv/detail/get_logger_levels__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rcl_interfaces::srv::GetLoggerLevels_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rcl_interfaces::srv::GetLoggerLevels_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLoggerLevels_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Request *>(
...
static size_t _GetLoggerLevels_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLoggerLevels_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLoggerLevels_Request__callbacks = {
  "rcl_interfaces::srv",
...
static rosidl_message_type_support_t _GetLoggerLevels_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLoggerLevels_Request__callbacks,
...
{
  return &rcl_interfaces::srv::typesupport_fastrtps_cpp::_GetLoggerLevels_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rcl_interfaces::srv::GetLoggerLevels_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rcl_interfaces::srv::GetLoggerLevels_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLoggerLevels_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Response *>(
...
static size_t _GetLoggerLevels_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLoggerLevels_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLoggerLevels_Response__callbacks = {
  "rcl_interfaces::srv",
...
static rosidl_message_type_support_t _GetLoggerLevels_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLoggerLevels_Response__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &rcl_interfaces::srv::typesupport_fastrtps_cpp::_GetLoggerLevels_Response__handle;
}
...
// functions for rcl_interfaces::srv::GetLoggerLevels_Request already declared above

// functions for rcl_interfaces::srv::GetLoggerLevels_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetLoggerLevels_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetLoggerLevels_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rcl_interfaces::srv::GetLoggerLevels_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetLoggerLevels_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetLoggerLevels_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rcl_interfaces::srv::GetLoggerLevels_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLoggerLevels_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::GetLoggerLevels_Event *>(
...
static size_t _GetLoggerLevels_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLoggerLevels_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLoggerLevels_Event__callbacks = {
  "rcl_interfaces::srv",
...
static rosidl_message_type_support_t _GetLoggerLevels_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLoggerLevels_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &rcl_interfaces::srv::typesupport_fastrtps_cpp::_GetLoggerLevels_Event__handle;
}
...
static service_type_support_callbacks_t _GetLoggerLevels__callbacks = {
  "rcl_interfaces::srv",
  "GetLoggerLevels",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rcl_interfaces, srv, GetLoggerLevels_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rcl_interfaces, srv, GetLoggerLevels_Response)(),
...
static const rosidl_service_type_support_t _GetLoggerLevels__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLoggerLevels__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rcl_interfaces::srv::GetLoggerLevels_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rcl_interfaces::srv::GetLoggerLevels_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rcl_interfaces::srv::GetLoggerLevels_Event>(),
...
{
  return &rcl_interfaces::srv::typesupport_fastrtps_cpp::_GetLoggerLevels__handle;
}
