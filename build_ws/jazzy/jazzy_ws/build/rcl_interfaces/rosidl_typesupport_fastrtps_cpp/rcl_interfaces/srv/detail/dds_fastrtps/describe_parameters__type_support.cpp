  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rcl_interfaces::srv::DescribeParameters_Request;
    is_plain =
      (
...
static size_t _DescribeParameters_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DescribeParameters_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rcl_interfaces::srv::DescribeParameters_Response;
    is_plain =
      (
...
static size_t _DescribeParameters_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DescribeParameters_Response(full_bounded, is_plain, 0);
...
// functions for rcl_interfaces::srv::DescribeParameters_Request already declared above

// functions for rcl_interfaces::srv::DescribeParameters_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_DescribeParameters_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_DescribeParameters_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rcl_interfaces::srv::DescribeParameters_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_DescribeParameters_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_DescribeParameters_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::DescribeParameters_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rcl_interfaces::srv::DescribeParameters_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DescribeParameters_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rcl_interfaces::srv::DescribeParameters_Event *>(
...
static size_t _DescribeParameters_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DescribeParameters_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DescribeParameters_Event__callbacks = {
  "rcl_interfaces::srv",
...
static rosidl_message_type_support_t _DescribeParameters_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DescribeParameters_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &rcl_interfaces::srv::typesupport_fastrtps_cpp::_DescribeParameters_Event__handle;
}
...
static const rosidl_service_type_support_t _DescribeParameters__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DescribeParameters__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rcl_interfaces::srv::DescribeParameters_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rcl_interfaces::srv::DescribeParameters_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rcl_interfaces::srv::DescribeParameters_Event>(),
