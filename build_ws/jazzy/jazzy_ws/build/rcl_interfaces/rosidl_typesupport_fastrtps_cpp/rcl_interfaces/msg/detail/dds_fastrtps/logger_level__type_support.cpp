...
#include "rcl_interfaces/msg/detail/logger_level__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rcl_interfaces::msg::LoggerLevel;
    is_plain =
      (
...
static size_t _LoggerLevel__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_LoggerLevel(full_bounded, is_plain, 0);
...
{
  return &rcl_interfaces::msg::typesupport_fastrtps_cpp::_LoggerLevel__handle;
}
