...
#include "rcl_interfaces/msg/detail/parameter_type__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rcl_interfaces::msg::ParameterType;
    is_plain =
      (
...
static size_t _ParameterType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ParameterType(full_bounded, is_plain, 0);
...
{
  return &rcl_interfaces::msg::typesupport_fastrtps_cpp::_ParameterType__handle;
}
