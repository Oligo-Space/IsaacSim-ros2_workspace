...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v0.1.1"
  WORKING_DIRECTORY "/workspace/jazzy_ws/build/iceoryx_posh/dependencies/cpptoml/src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v0.1.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v0.1.1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v0.1.1\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspace/jazzy_ws/build/iceoryx_posh/dependencies/cpptoml/src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/jazzy_ws/build/iceoryx_posh/dependencies/cpptoml/src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
