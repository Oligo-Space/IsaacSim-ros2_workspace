...
#include "trajectory_msgs/msg/detail/multi_dof_joint_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "trajectory_msgs/msg/detail/multi_dof_joint_trajectory_point__functions.h"  // points
  ...
  trajectory_msgs__msg__MultiDOFJointTrajectory * ros_message)
{
  ...
  // Field name: points
  {
    ...
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_trajectory_msgs__msg__MultiDOFJointTrajectoryPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_msgs__msg__MultiDOFJointTrajectory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const trajectory_msgs__msg__MultiDOFJointTrajectory * ros_message = static_cast<const trajectory_msgs__msg__MultiDOFJointTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_trajectory_msgs__msg__MultiDOFJointTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  trajectory_msgs__msg__MultiDOFJointTrajectory * ros_message = static_cast<trajectory_msgs__msg__MultiDOFJointTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_trajectory_msgs__msg__MultiDOFJointTrajectory(cdr, ros_message);
}
...
static size_t _MultiDOFJointTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_trajectory_msgs__msg__MultiDOFJointTrajectory(
