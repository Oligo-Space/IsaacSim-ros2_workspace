...
#include "trajectory_msgs/msg/detail/joint_trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
using _JointTrajectoryPoint__ros_msg_type = trajectory_msgs__msg__JointTrajectoryPoint;
  ...
  trajectory_msgs__msg__JointTrajectoryPoint * ros_message)
{
  ...
  // Field name: accelerations
  {
    ...
    if (ros_message->accelerations.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->accelerations);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->accelerations, size)) {
...
size_t get_serialized_size_trajectory_msgs__msg__JointTrajectoryPoint(
  ...
  size_t current_alignment)
{
  const _JointTrajectoryPoint__ros_msg_type * ros_message = static_cast<const _JointTrajectoryPoint__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_msgs__msg__JointTrajectoryPoint;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const trajectory_msgs__msg__JointTrajectoryPoint * ros_message = static_cast<const trajectory_msgs__msg__JointTrajectoryPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_trajectory_msgs__msg__JointTrajectoryPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  trajectory_msgs__msg__JointTrajectoryPoint * ros_message = static_cast<trajectory_msgs__msg__JointTrajectoryPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_trajectory_msgs__msg__JointTrajectoryPoint(cdr, ros_message);
}
...
static size_t _JointTrajectoryPoint__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_trajectory_msgs__msg__JointTrajectoryPoint(
