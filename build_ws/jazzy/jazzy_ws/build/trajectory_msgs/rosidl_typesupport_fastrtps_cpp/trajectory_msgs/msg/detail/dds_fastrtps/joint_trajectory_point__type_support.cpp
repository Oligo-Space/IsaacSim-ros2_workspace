...
#include "trajectory_msgs/msg/detail/joint_trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_msgs::msg::JointTrajectoryPoint;
    is_plain =
      (
...
static size_t _JointTrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointTrajectoryPoint(full_bounded, is_plain, 0);
...
{
  return &trajectory_msgs::msg::typesupport_fastrtps_cpp::_JointTrajectoryPoint__handle;
}
