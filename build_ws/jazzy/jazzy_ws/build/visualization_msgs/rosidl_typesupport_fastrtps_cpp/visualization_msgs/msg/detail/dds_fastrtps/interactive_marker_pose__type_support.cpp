...
#include "visualization_msgs/msg/detail/interactive_marker_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = visualization_msgs::msg::InteractiveMarkerPose;
    is_plain =
      (
...
static size_t _InteractiveMarkerPose__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_InteractiveMarkerPose(full_bounded, is_plain, 0);
...
{
  return &visualization_msgs::msg::typesupport_fastrtps_cpp::_InteractiveMarkerPose__handle;
}
