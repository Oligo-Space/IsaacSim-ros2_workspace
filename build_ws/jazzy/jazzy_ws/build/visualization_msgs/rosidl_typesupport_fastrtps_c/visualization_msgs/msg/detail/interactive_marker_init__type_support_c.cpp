  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const visualization_msgs__msg__InteractiveMarkerInit * ros_message = static_cast<const visualization_msgs__msg__InteractiveMarkerInit *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_visualization_msgs__msg__InteractiveMarkerInit(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  visualization_msgs__msg__InteractiveMarkerInit * ros_message = static_cast<visualization_msgs__msg__InteractiveMarkerInit *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_visualization_msgs__msg__InteractiveMarkerInit(cdr, ros_message);
}
