  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: poses
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_visualization_msgs__msg__InteractiveMarkerPose(
        &array_ptr[i], cdr);
    }
  }
  ...
  visualization_msgs__msg__InteractiveMarkerUpdate * ros_message)
{
  ...
  // Field name: poses
  {
    ...
    auto array_ptr = ros_message->poses.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_visualization_msgs__msg__InteractiveMarkerPose(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: poses
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_visualization_msgs__msg__InteractiveMarkerPose(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_visualization_msgs__msg__InteractiveMarkerPose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: poses
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_visualization_msgs__msg__InteractiveMarkerPose(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: poses
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_visualization_msgs__msg__InteractiveMarkerPose(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_visualization_msgs__msg__InteractiveMarkerPose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const visualization_msgs__msg__InteractiveMarkerUpdate * ros_message = static_cast<const visualization_msgs__msg__InteractiveMarkerUpdate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_visualization_msgs__msg__InteractiveMarkerUpdate(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  visualization_msgs__msg__InteractiveMarkerUpdate * ros_message = static_cast<visualization_msgs__msg__InteractiveMarkerUpdate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_visualization_msgs__msg__InteractiveMarkerUpdate(cdr, ros_message);
}
...
static size_t _InteractiveMarkerUpdate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_visualization_msgs__msg__InteractiveMarkerUpdate(
