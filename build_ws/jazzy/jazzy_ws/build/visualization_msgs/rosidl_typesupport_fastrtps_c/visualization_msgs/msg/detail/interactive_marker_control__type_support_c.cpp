  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const visualization_msgs__msg__InteractiveMarkerControl * ros_message = static_cast<const visualization_msgs__msg__InteractiveMarkerControl *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_visualization_msgs__msg__InteractiveMarkerControl(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  visualization_msgs__msg__InteractiveMarkerControl * ros_message = static_cast<visualization_msgs__msg__InteractiveMarkerControl *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_visualization_msgs__msg__InteractiveMarkerControl(cdr, ros_message);
}
...
static size_t _InteractiveMarkerControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_visualization_msgs__msg__InteractiveMarkerControl(
