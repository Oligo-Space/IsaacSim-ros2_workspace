...
// functions for tf2_msgs::srv::FrameGraph_Request already declared above

// functions for tf2_msgs::srv::FrameGraph_Response already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      tf2_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  tf2_msgs::srv::FrameGraph_Event & ros_message)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      tf2_msgs::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        tf2_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tf2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_FrameGraph_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tf2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_FrameGraph_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_msgs::srv::FrameGraph_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      tf2_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        tf2_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tf2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_FrameGraph_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tf2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_FrameGraph_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const tf2_msgs::srv::FrameGraph_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tf2_msgs::srv::FrameGraph_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FrameGraph_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tf2_msgs::srv::FrameGraph_Event *>(
...
static size_t _FrameGraph_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FrameGraph_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FrameGraph_Event__callbacks = {
  "tf2_msgs::srv",
  "FrameGraph_Event",
...
static rosidl_message_type_support_t _FrameGraph_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FrameGraph_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &tf2_msgs::srv::typesupport_fastrtps_cpp::_FrameGraph_Event__handle;
}
...
static const rosidl_service_type_support_t _FrameGraph__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FrameGraph__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<tf2_msgs::srv::FrameGraph_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<tf2_msgs::srv::FrameGraph_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<tf2_msgs::srv::FrameGraph_Event>(),
