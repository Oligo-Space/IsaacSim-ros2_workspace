...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\libyaml_vendor\bin"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\libyaml_vendor\lib"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\libyaml_vendor\lib64"
