  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: drive
  ackermann_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.drive,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: drive
  current_alignment +=
    ackermann_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.drive, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ackermann_msgs
max_serialized_size_key_AckermannDriveStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: drive
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ackermann_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_AckermannDrive(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
