...
#include "ackermann_msgs/msg/detail/ackermann_drive__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ackermann_msgs__msg__AckermannDrive;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ackermann_msgs__msg__AckermannDrive * ros_message = static_cast<const ackermann_msgs__msg__AckermannDrive *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ackermann_msgs__msg__AckermannDrive(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ackermann_msgs__msg__AckermannDrive * ros_message = static_cast<ackermann_msgs__msg__AckermannDrive *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ackermann_msgs__msg__AckermannDrive(cdr, ros_message);
}
...
static size_t _AckermannDrive__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ackermann_msgs__msg__AckermannDrive(
