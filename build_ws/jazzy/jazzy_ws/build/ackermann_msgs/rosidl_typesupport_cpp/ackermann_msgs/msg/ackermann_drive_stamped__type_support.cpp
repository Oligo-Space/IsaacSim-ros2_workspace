...
static const _AckermannDriveStamped_type_support_symbol_names_t _AckermannDriveStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ackermann_msgs, msg, AckermannDriveStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ackermann_msgs, msg, AckermannDriveStamped)),
  }
};
...
{
  return &::ackermann_msgs::msg::rosidl_typesupport_cpp::AckermannDriveStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ackermann_msgs, msg, AckermannDriveStamped)() {
  return get_message_type_support_handle<ackermann_msgs::msg::AckermannDriveStamped>();
}
