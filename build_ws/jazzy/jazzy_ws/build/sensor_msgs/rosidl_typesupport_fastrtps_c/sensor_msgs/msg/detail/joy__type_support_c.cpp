...
#include "sensor_msgs/msg/detail/joy__rosidl_typesupport_fastrtps_c.h"
...
using _Joy__ros_msg_type = sensor_msgs__msg__Joy;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs__msg__Joy;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__Joy * ros_message = static_cast<const sensor_msgs__msg__Joy *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__Joy(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__Joy * ros_message = static_cast<sensor_msgs__msg__Joy *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__Joy(cdr, ros_message);
}
...
static size_t _Joy__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensor_msgs__msg__Joy(
