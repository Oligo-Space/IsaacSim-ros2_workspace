...
#include "sensor_msgs/msg/detail/point_cloud2__rosidl_typesupport_fastrtps_c.h"
...
using _PointCloud2__ros_msg_type = sensor_msgs__msg__PointCloud2;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fields
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_sensor_msgs__msg__PointField(
        &array_ptr[i], cdr);
    }
  }
  ...
  sensor_msgs__msg__PointCloud2 * ros_message)
{
  ...
  // Field name: fields
  {
    ...
    auto array_ptr = ros_message->fields.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_sensor_msgs__msg__PointField(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_sensor_msgs__msg__PointCloud2(
  ...
  size_t current_alignment)
{
  const _PointCloud2__ros_msg_type * ros_message = static_cast<const _PointCloud2__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs__msg__PointCloud2;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fields
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_sensor_msgs__msg__PointField(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: fields
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_sensor_msgs__msg__PointField(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: fields
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_sensor_msgs__msg__PointField(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__PointCloud2 * ros_message = static_cast<const sensor_msgs__msg__PointCloud2 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__PointCloud2(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__PointCloud2 * ros_message = static_cast<sensor_msgs__msg__PointCloud2 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__PointCloud2(cdr, ros_message);
}
...
static size_t _PointCloud2__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensor_msgs__msg__PointCloud2(
