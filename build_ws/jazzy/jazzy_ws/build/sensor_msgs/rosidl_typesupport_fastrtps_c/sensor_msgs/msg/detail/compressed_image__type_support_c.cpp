...
#include "sensor_msgs/msg/detail/compressed_image__rosidl_typesupport_fastrtps_c.h"
...
using _CompressedImage__ros_msg_type = sensor_msgs__msg__CompressedImage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs__msg__CompressedImage;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__CompressedImage * ros_message = static_cast<const sensor_msgs__msg__CompressedImage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__CompressedImage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__CompressedImage * ros_message = static_cast<sensor_msgs__msg__CompressedImage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__CompressedImage(cdr, ros_message);
}
...
static size_t _CompressedImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensor_msgs__msg__CompressedImage(
