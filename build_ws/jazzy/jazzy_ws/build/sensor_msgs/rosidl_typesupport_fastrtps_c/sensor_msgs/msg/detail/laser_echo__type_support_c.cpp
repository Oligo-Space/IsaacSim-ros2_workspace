  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__LaserEcho * ros_message = static_cast<const sensor_msgs__msg__LaserEcho *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__LaserEcho(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__LaserEcho * ros_message = static_cast<sensor_msgs__msg__LaserEcho *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__LaserEcho(cdr, ros_message);
}
