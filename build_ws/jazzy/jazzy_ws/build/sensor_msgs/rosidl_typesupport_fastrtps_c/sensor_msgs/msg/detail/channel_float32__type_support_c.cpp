...
#include "sensor_msgs/msg/detail/channel_float32__rosidl_typesupport_fastrtps_c.h"
...
using _ChannelFloat32__ros_msg_type = sensor_msgs__msg__ChannelFloat32;
...
{
  const _ChannelFloat32__ros_msg_type * ros_message = static_cast<const _ChannelFloat32__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs__msg__ChannelFloat32;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor_msgs__msg__ChannelFloat32 * ros_message = static_cast<const sensor_msgs__msg__ChannelFloat32 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor_msgs__msg__ChannelFloat32(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor_msgs__msg__ChannelFloat32 * ros_message = static_cast<sensor_msgs__msg__ChannelFloat32 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor_msgs__msg__ChannelFloat32(cdr, ros_message);
}
...
static size_t _ChannelFloat32__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_sensor_msgs__msg__ChannelFloat32(
