...
static size_t _PointField__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PointField(full_bounded, is_plain, 0);
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_PointField__handle;
}
