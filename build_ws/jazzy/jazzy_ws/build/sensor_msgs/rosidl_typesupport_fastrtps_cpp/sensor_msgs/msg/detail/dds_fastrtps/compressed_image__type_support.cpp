...
#include "sensor_msgs/msg/detail/compressed_image__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::CompressedImage;
    is_plain =
      (
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_CompressedImage__handle;
}
