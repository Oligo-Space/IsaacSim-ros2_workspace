...
#include "sensor_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
