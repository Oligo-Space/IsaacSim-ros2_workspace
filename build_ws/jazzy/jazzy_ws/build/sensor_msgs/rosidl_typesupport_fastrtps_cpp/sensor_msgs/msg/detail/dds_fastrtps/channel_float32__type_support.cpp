...
#include "sensor_msgs/msg/detail/channel_float32__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::ChannelFloat32;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_msgs::msg::ChannelFloat32 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_msgs::msg::ChannelFloat32 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ChannelFloat32__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sensor_msgs::msg::ChannelFloat32 *>(
...
static size_t _ChannelFloat32__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ChannelFloat32(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ChannelFloat32__callbacks = {
  "sensor_msgs::msg",
  "ChannelFloat32",
...
static rosidl_message_type_support_t _ChannelFloat32__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChannelFloat32__callbacks,
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_ChannelFloat32__handle;
}
