...
#include "sensor_msgs/msg/detail/fluid_pressure__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::FluidPressure;
    is_plain =
      (
...
static size_t _FluidPressure__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_FluidPressure(full_bounded, is_plain, 0);
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_FluidPressure__handle;
}
