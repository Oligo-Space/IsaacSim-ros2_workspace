...
#include "sensor_msgs/msg/detail/joy_feedback_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sensor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_JoyFeedback(
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::JoyFeedbackArray;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sensor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_JoyFeedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const sensor_msgs::msg::JoyFeedbackArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_msgs::msg::JoyFeedbackArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JoyFeedbackArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sensor_msgs::msg::JoyFeedbackArray *>(
...
static size_t _JoyFeedbackArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JoyFeedbackArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JoyFeedbackArray__callbacks = {
  "sensor_msgs::msg",
  "JoyFeedbackArray",
...
static rosidl_message_type_support_t _JoyFeedbackArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JoyFeedbackArray__callbacks,
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_JoyFeedbackArray__handle;
}
