...
#include "sensor_msgs/msg/detail/temperature__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::Temperature;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_msgs::msg::Temperature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_msgs::msg::Temperature *>(
    untyped_ros_message);
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_Temperature__handle;
}
