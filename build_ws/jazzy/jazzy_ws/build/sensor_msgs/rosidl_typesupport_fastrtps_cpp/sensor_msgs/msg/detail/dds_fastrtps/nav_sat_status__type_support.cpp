...
#include "sensor_msgs/msg/detail/nav_sat_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_msgs::msg::NavSatStatus;
    is_plain =
      (
...
static size_t _NavSatStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NavSatStatus(full_bounded, is_plain, 0);
...
{
  return &sensor_msgs::msg::typesupport_fastrtps_cpp::_NavSatStatus__handle;
}
