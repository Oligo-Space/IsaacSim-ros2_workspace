...
#include "std_srvs/srv/detail/trigger__rosidl_typesupport_fastrtps_c.h"
...
using _Trigger_Request__ros_msg_type = std_srvs__srv__Trigger_Request;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_srvs__srv__Trigger_Request;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_srvs__srv__Trigger_Request * ros_message = static_cast<const std_srvs__srv__Trigger_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_srvs__srv__Trigger_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_srvs__srv__Trigger_Request * ros_message = static_cast<std_srvs__srv__Trigger_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_srvs__srv__Trigger_Request(cdr, ros_message);
}
...
static size_t _Trigger_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_srvs__srv__Trigger_Request(
...
using _Trigger_Response__ros_msg_type = std_srvs__srv__Trigger_Response;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs__srv__Trigger_Response;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_srvs__srv__Trigger_Response * ros_message = static_cast<const std_srvs__srv__Trigger_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_srvs__srv__Trigger_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_srvs__srv__Trigger_Response * ros_message = static_cast<std_srvs__srv__Trigger_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_srvs__srv__Trigger_Response(cdr, ros_message);
}
...
static size_t _Trigger_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_srvs__srv__Trigger_Response(
    full_bounded, is_plain, 0);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_std_srvs
...
using _Trigger_Event__ros_msg_type = std_srvs__srv__Trigger_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_std_srvs__srv__Trigger_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_std_srvs__srv__Trigger_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  std_srvs__srv__Trigger_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      std_srvs__srv__Trigger_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_std_srvs__srv__Trigger_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      std_srvs__srv__Trigger_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_std_srvs__srv__Trigger_Response(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_std_srvs__srv__Trigger_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_std_srvs__srv__Trigger_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_std_srvs__srv__Trigger_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_std_srvs__srv__Trigger_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs__srv__Trigger_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_std_srvs__srv__Trigger_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_std_srvs__srv__Trigger_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_std_srvs__srv__Trigger_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_std_srvs__srv__Trigger_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_std_srvs__srv__Trigger_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_std_srvs__srv__Trigger_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_srvs__srv__Trigger_Event * ros_message = static_cast<const std_srvs__srv__Trigger_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_srvs__srv__Trigger_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_srvs__srv__Trigger_Event * ros_message = static_cast<std_srvs__srv__Trigger_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_srvs__srv__Trigger_Event(cdr, ros_message);
}

static uint32_t _Trigger_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_srvs__srv__Trigger_Event(
      untyped_ros_message, 0));
}
...
static size_t _Trigger_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_srvs__srv__Trigger_Event(
    full_bounded, is_plain, 0);
