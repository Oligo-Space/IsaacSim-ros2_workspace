  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_srvs::srv::Empty_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs::srv::Empty_Response;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
// functions for std_srvs::srv::Empty_Request already declared above

// functions for std_srvs::srv::Empty_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_Empty_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_Empty_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs::srv::Empty_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Empty_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Empty_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const std_srvs::srv::Empty_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<std_srvs::srv::Empty_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Empty_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const std_srvs::srv::Empty_Event *>(
...
static size_t _Empty_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Empty_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Empty_Event__callbacks = {
  "std_srvs::srv",
  "Empty_Event",
...
static rosidl_message_type_support_t _Empty_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Empty_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &std_srvs::srv::typesupport_fastrtps_cpp::_Empty_Event__handle;
}
...
static const rosidl_service_type_support_t _Empty__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Empty__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::Empty_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::Empty_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::Empty_Event>(),
