...
// functions for std_srvs::srv::Trigger_Request already declared above

// functions for std_srvs::srv::Trigger_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_Trigger_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_Trigger_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs::srv::Trigger_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Trigger_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Trigger_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const std_srvs::srv::Trigger_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<std_srvs::srv::Trigger_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &std_srvs::srv::typesupport_fastrtps_cpp::_Trigger_Event__handle;
}
...
static const rosidl_service_type_support_t _Trigger__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::Trigger_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::Trigger_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::Trigger_Event>(),
