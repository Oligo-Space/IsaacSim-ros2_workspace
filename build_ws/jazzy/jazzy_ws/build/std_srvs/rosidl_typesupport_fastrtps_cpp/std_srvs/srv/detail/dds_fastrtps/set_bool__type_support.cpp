...
#include "std_srvs/srv/detail/set_bool__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_srvs::srv::SetBool_Request;
    is_plain =
      (
...
{
  return &std_srvs::srv::typesupport_fastrtps_cpp::_SetBool_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs::srv::SetBool_Response;
    is_plain =
      (
...
{
  return &std_srvs::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
// functions for std_srvs::srv::SetBool_Request already declared above

// functions for std_srvs::srv::SetBool_Response already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      std_srvs::srv::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  std_srvs::srv::SetBool_Event & ros_message)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      std_srvs::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        std_srvs::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetBool_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetBool_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = std_srvs::srv::SetBool_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      std_srvs::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        std_srvs::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetBool_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_srvs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetBool_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const std_srvs::srv::SetBool_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<std_srvs::srv::SetBool_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &std_srvs::srv::typesupport_fastrtps_cpp::_SetBool_Event__handle;
}
...
static const rosidl_service_type_support_t _SetBool__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::SetBool_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::SetBool_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<std_srvs::srv::SetBool_Event>(),
...
{
  return &std_srvs::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
