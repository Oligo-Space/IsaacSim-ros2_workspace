...
@launch_testing.parametrize(
    ...
    [
        ...
        (None, ''),
        # Test both.
        ('rmw_fastrtps_dynamic_cpp', 'rmw_fastrtps_dynamic_cpp'),
        ('garbage', 'rmw_fastrtps_dynamic_cpp'),
        ('rmw_fastrtps_dynamic_cpp', 'garbage'),
        ('garbage', 'garbage'),
        ('', ''),
    ]
)
def generate_test_description(
    ...
    executable_under_test = ExecuteProcess(
        cmd=['/workspace/jazzy_ws/build/rcl/test/test_rmw_impl_id_check_exe'],
        name='/workspace/jazzy_ws/build/rcl/test/test_rmw_impl_id_check_exe',
        env=env,
    )
