...
#include "example_interfaces/msg/detail/float64_multi_array__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces__msg__Float64MultiArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const example_interfaces__msg__Float64MultiArray * ros_message = static_cast<const example_interfaces__msg__Float64MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_example_interfaces__msg__Float64MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  example_interfaces__msg__Float64MultiArray * ros_message = static_cast<example_interfaces__msg__Float64MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_example_interfaces__msg__Float64MultiArray(cdr, ros_message);
}
...
static size_t _Float64MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__msg__Float64MultiArray(
