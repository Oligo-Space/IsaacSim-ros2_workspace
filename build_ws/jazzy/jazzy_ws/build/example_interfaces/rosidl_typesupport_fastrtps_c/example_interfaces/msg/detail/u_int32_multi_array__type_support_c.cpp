  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces__msg__UInt32MultiArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const example_interfaces__msg__UInt32MultiArray * ros_message = static_cast<const example_interfaces__msg__UInt32MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_example_interfaces__msg__UInt32MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  example_interfaces__msg__UInt32MultiArray * ros_message = static_cast<example_interfaces__msg__UInt32MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_example_interfaces__msg__UInt32MultiArray(cdr, ros_message);
}
...
static size_t _UInt32MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__msg__UInt32MultiArray(
