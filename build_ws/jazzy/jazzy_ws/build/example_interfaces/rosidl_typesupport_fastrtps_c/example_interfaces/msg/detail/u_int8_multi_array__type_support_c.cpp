...
#include "example_interfaces/msg/detail/u_int8_multi_array__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces__msg__UInt8MultiArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const example_interfaces__msg__UInt8MultiArray * ros_message = static_cast<const example_interfaces__msg__UInt8MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_example_interfaces__msg__UInt8MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  example_interfaces__msg__UInt8MultiArray * ros_message = static_cast<example_interfaces__msg__UInt8MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_example_interfaces__msg__UInt8MultiArray(cdr, ros_message);
}
...
static size_t _UInt8MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__msg__UInt8MultiArray(
