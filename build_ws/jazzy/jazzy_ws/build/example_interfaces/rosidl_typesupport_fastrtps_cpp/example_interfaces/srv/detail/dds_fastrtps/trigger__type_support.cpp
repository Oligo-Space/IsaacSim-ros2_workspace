  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces::srv::Trigger_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::srv::Trigger_Response;
    is_plain =
      (
...
// functions for example_interfaces::srv::Trigger_Request already declared above

// functions for example_interfaces::srv::Trigger_Response already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      example_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  example_interfaces::srv::Trigger_Event & ros_message)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      example_interfaces::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        example_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_Trigger_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_Trigger_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::srv::Trigger_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      example_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        example_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Trigger_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Trigger_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const example_interfaces::srv::Trigger_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::srv::Trigger_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Trigger_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const example_interfaces::srv::Trigger_Event *>(
...
static size_t _Trigger_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Trigger_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Trigger_Event__callbacks = {
  "example_interfaces::srv",
  "Trigger_Event",
...
static rosidl_message_type_support_t _Trigger_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Trigger_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &example_interfaces::srv::typesupport_fastrtps_cpp::_Trigger_Event__handle;
}
...
static const rosidl_service_type_support_t _Trigger__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Trigger__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::srv::Trigger_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::srv::Trigger_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::srv::Trigger_Event>(),
