...
#include "example_interfaces/action/detail/fibonacci__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces::action::Fibonacci_Goal;
    is_plain =
      (
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_Result;
    is_plain =
      (
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_Feedback;
    is_plain =
      (
      offsetof(DataType, sequence) +
      last_member_size
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
// functions for example_interfaces::action::Fibonacci_Goal already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: goal
  example_interfaces::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  ...
  example_interfaces::action::Fibonacci_SendGoal_Request & ros_message)
{
  ...
  // Member: goal
  example_interfaces::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  current_alignment +=
    example_interfaces::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_SendGoal_Request;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: goal
  example_interfaces::action::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.goal,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  current_alignment +=
    example_interfaces::action::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.goal, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_SendGoal_Response;
    is_plain =
      (
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
// functions for example_interfaces::action::Fibonacci_SendGoal_Request already declared above

// functions for example_interfaces::action::Fibonacci_SendGoal_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_SendGoal_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::Fibonacci_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::Fibonacci_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _Fibonacci_SendGoal__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::action::Fibonacci_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::action::Fibonacci_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::action::Fibonacci_SendGoal_Event>(),
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_GetResult_Request;
    is_plain =
      (
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for example_interfaces::action::Fibonacci_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_GetResult_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
// functions for example_interfaces::action::Fibonacci_GetResult_Request already declared above

// functions for example_interfaces::action::Fibonacci_GetResult_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::Fibonacci_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::Fibonacci_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _Fibonacci_GetResult__handle{
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::action::Fibonacci_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::action::Fibonacci_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<example_interfaces::action::Fibonacci_GetResult_Event>(),
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
// functions for example_interfaces::action::Fibonacci_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::Fibonacci_FeedbackMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
