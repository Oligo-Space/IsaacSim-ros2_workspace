...
#include "actionlib_msgs/msg/detail/goal_status_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = actionlib_msgs::msg::GoalStatusArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: status_list
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      actionlib_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.status_list[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: status_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        actionlib_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.status_list[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: status_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        actionlib_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_GoalStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const actionlib_msgs::msg::GoalStatusArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<actionlib_msgs::msg::GoalStatusArray *>(
    untyped_ros_message);
...
{
  return &actionlib_msgs::msg::typesupport_fastrtps_cpp::_GoalStatusArray__handle;
}
