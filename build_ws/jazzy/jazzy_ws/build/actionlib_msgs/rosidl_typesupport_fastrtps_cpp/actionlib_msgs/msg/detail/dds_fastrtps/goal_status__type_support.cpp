...
#include "actionlib_msgs/msg/detail/goal_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = actionlib_msgs::msg::GoalStatus;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: goal_id
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        actionlib_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_GoalID(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
