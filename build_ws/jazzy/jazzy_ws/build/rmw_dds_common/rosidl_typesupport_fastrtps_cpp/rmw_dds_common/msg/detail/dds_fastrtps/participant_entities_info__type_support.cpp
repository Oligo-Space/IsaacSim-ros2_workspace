...
{
  // Member: gid
  rmw_dds_common::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.gid,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: gid
  current_alignment +=
    rmw_dds_common::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.gid, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: gid
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rmw_dds_common::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Gid(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: node_entities_info_seq
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rmw_dds_common::msg::typesupport_fastrtps_cpp::max_serialized_size_key_NodeEntitiesInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
