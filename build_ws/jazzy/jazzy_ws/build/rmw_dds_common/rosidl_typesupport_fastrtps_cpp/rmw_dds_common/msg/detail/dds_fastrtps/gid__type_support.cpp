  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmw_dds_common::msg::Gid;
    is_plain =
      (
...
static size_t _Gid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Gid(full_bounded, is_plain, 0);
...
{
  return &rmw_dds_common::msg::typesupport_fastrtps_cpp::_Gid__handle;
}
