  ...
  rmw_dds_common__msg__NodeEntitiesInfo * ros_message)
{
  ...
  // Field name: reader_gid_seq
  {
    ...
    auto array_ptr = ros_message->reader_gid_seq.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rmw_dds_common__msg__Gid(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rmw_dds_common__msg__NodeEntitiesInfo * ros_message = static_cast<const rmw_dds_common__msg__NodeEntitiesInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rmw_dds_common__msg__NodeEntitiesInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rmw_dds_common__msg__NodeEntitiesInfo * ros_message = static_cast<rmw_dds_common__msg__NodeEntitiesInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rmw_dds_common__msg__NodeEntitiesInfo(cdr, ros_message);
}
