...
#include "rmw_dds_common/msg/detail/gid__rosidl_typesupport_fastrtps_c.h"
...
using _Gid__ros_msg_type = rmw_dds_common__msg__Gid;
...
{
  const _Gid__ros_msg_type * ros_message = static_cast<const _Gid__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmw_dds_common__msg__Gid;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rmw_dds_common__msg__Gid * ros_message = static_cast<const rmw_dds_common__msg__Gid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rmw_dds_common__msg__Gid(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rmw_dds_common__msg__Gid * ros_message = static_cast<rmw_dds_common__msg__Gid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rmw_dds_common__msg__Gid(cdr, ros_message);
}

static uint32_t _Gid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmw_dds_common__msg__Gid(
      untyped_ros_message, 0));
}

static size_t _Gid__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rmw_dds_common__msg__Gid(
...
static message_type_support_callbacks_t __callbacks_Gid = {
  "rmw_dds_common::msg",
  "Gid",
  _Gid__cdr_serialize,
...
static rosidl_message_type_support_t _Gid__type_support = {
