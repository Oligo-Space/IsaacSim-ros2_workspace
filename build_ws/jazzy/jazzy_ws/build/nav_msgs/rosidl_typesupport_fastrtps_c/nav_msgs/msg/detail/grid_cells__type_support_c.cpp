  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav_msgs__msg__GridCells * ros_message = static_cast<const nav_msgs__msg__GridCells *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav_msgs__msg__GridCells(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav_msgs__msg__GridCells * ros_message = static_cast<nav_msgs__msg__GridCells *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav_msgs__msg__GridCells(cdr, ros_message);
}
...
static size_t _GridCells__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_nav_msgs__msg__GridCells(
