  ...
  nav_msgs__msg__OccupancyGrid * ros_message)
{
  ...
  // Field name: info
  {
    cdr_deserialize_nav_msgs__msg__MapMetaData(cdr, &ros_message->info);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav_msgs__msg__OccupancyGrid * ros_message = static_cast<const nav_msgs__msg__OccupancyGrid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav_msgs__msg__OccupancyGrid(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav_msgs__msg__OccupancyGrid * ros_message = static_cast<nav_msgs__msg__OccupancyGrid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav_msgs__msg__OccupancyGrid(cdr, ros_message);
}
...
static size_t _OccupancyGrid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav_msgs__msg__OccupancyGrid(
