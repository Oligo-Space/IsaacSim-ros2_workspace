...
#include "nav_msgs/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
using _Path__ros_msg_type = nav_msgs__msg__Path;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_msgs__msg__Path;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav_msgs__msg__Path * ros_message = static_cast<const nav_msgs__msg__Path *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav_msgs__msg__Path(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav_msgs__msg__Path * ros_message = static_cast<nav_msgs__msg__Path *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav_msgs__msg__Path(cdr, ros_message);
}

static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav_msgs__msg__Path(
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav_msgs__msg__Path(
