  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav_msgs__msg__Goals * ros_message = static_cast<const nav_msgs__msg__Goals *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav_msgs__msg__Goals(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav_msgs__msg__Goals * ros_message = static_cast<nav_msgs__msg__Goals *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav_msgs__msg__Goals(cdr, ros_message);
}
