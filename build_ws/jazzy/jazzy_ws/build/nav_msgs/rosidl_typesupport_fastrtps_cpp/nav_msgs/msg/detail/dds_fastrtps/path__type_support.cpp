...
#include "nav_msgs/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_msgs::msg::Path;
    is_plain =
      (
...
{
  return &nav_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
