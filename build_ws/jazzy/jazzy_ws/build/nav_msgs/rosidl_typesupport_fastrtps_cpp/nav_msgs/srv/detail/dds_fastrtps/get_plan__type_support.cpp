...
#include "nav_msgs/srv/detail/get_plan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_msgs::srv::GetPlan_Request;
    is_plain =
      (
...
{
  return &nav_msgs::srv::typesupport_fastrtps_cpp::_GetPlan_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav_msgs::srv::GetPlan_Response;
    is_plain =
      (
...
{
  return &nav_msgs::srv::typesupport_fastrtps_cpp::_GetPlan_Response__handle;
}
...
// functions for nav_msgs::srv::GetPlan_Request already declared above

// functions for nav_msgs::srv::GetPlan_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetPlan_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetPlan_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav_msgs::srv::GetPlan_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetPlan_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetPlan_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const nav_msgs::srv::GetPlan_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav_msgs::srv::GetPlan_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &nav_msgs::srv::typesupport_fastrtps_cpp::_GetPlan_Event__handle;
}
...
static const rosidl_service_type_support_t _GetPlan__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<nav_msgs::srv::GetPlan_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<nav_msgs::srv::GetPlan_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<nav_msgs::srv::GetPlan_Event>(),
...
{
  return &nav_msgs::srv::typesupport_fastrtps_cpp::_GetPlan__handle;
}
