  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__srv__GetAvailableTransitions_Request * ros_message = static_cast<const lifecycle_msgs__srv__GetAvailableTransitions_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__srv__GetAvailableTransitions_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__srv__GetAvailableTransitions_Request * ros_message = static_cast<lifecycle_msgs__srv__GetAvailableTransitions_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__srv__GetAvailableTransitions_Request(cdr, ros_message);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: available_transitions
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_lifecycle_msgs__msg__TransitionDescription(
        &array_ptr[i], cdr);
    }
  }
  ...
  lifecycle_msgs__srv__GetAvailableTransitions_Response * ros_message)
{
  // Field name: available_transitions
  {
    ...
    auto array_ptr = ros_message->available_transitions.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_lifecycle_msgs__msg__TransitionDescription(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: available_transitions
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_lifecycle_msgs__msg__TransitionDescription(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: available_transitions
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_lifecycle_msgs__msg__TransitionDescription(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: available_transitions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_lifecycle_msgs__msg__TransitionDescription(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__srv__GetAvailableTransitions_Response * ros_message = static_cast<const lifecycle_msgs__srv__GetAvailableTransitions_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__srv__GetAvailableTransitions_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__srv__GetAvailableTransitions_Response * ros_message = static_cast<lifecycle_msgs__srv__GetAvailableTransitions_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__srv__GetAvailableTransitions_Response(cdr, ros_message);
}
...
using _GetAvailableTransitions_Event__ros_msg_type = lifecycle_msgs__srv__GetAvailableTransitions_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_lifecycle_msgs__srv__GetAvailableTransitions_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_lifecycle_msgs__srv__GetAvailableTransitions_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  lifecycle_msgs__srv__GetAvailableTransitions_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      lifecycle_msgs__srv__GetAvailableTransitions_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_lifecycle_msgs__srv__GetAvailableTransitions_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      lifecycle_msgs__srv__GetAvailableTransitions_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_lifecycle_msgs__srv__GetAvailableTransitions_Response(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Event(
  ...
  size_t current_alignment)
{
  const _GetAvailableTransitions_Event__ros_msg_type * ros_message = static_cast<const _GetAvailableTransitions_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs__srv__GetAvailableTransitions_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_lifecycle_msgs__srv__GetAvailableTransitions_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_lifecycle_msgs__srv__GetAvailableTransitions_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_lifecycle_msgs__srv__GetAvailableTransitions_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_lifecycle_msgs__srv__GetAvailableTransitions_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_lifecycle_msgs__srv__GetAvailableTransitions_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_lifecycle_msgs__srv__GetAvailableTransitions_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _GetAvailableTransitions_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const lifecycle_msgs__srv__GetAvailableTransitions_Event * ros_message = static_cast<const lifecycle_msgs__srv__GetAvailableTransitions_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__srv__GetAvailableTransitions_Event(ros_message, cdr);
}

static bool _GetAvailableTransitions_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  lifecycle_msgs__srv__GetAvailableTransitions_Event * ros_message = static_cast<lifecycle_msgs__srv__GetAvailableTransitions_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__srv__GetAvailableTransitions_Event(cdr, ros_message);
}

static uint32_t _GetAvailableTransitions_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Event(
      untyped_ros_message, 0));
}

static size_t _GetAvailableTransitions_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_GetAvailableTransitions_Event = {
  "lifecycle_msgs::srv",
  "GetAvailableTransitions_Event",
  _GetAvailableTransitions_Event__cdr_serialize,
  _GetAvailableTransitions_Event__cdr_deserialize,
  _GetAvailableTransitions_Event__get_serialized_size,
  _GetAvailableTransitions_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _GetAvailableTransitions_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GetAvailableTransitions_Event,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lifecycle_msgs, srv, GetAvailableTransitions_Event)() {
  return &_GetAvailableTransitions_Event__type_support;
}
...
static rosidl_service_type_support_t GetAvailableTransitions__handle = {
  ...
  &_GetAvailableTransitions_Request__type_support,
  &_GetAvailableTransitions_Response__type_support,
  &_GetAvailableTransitions_Event__type_support,
