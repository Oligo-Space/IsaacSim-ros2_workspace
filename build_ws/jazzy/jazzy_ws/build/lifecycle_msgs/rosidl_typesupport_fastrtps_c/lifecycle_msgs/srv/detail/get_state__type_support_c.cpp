...
#include "lifecycle_msgs/srv/detail/get_state__rosidl_typesupport_fastrtps_c.h"
...
using _GetState_Request__ros_msg_type = lifecycle_msgs__srv__GetState_Request;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lifecycle_msgs__srv__GetState_Request;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__srv__GetState_Request * ros_message = static_cast<const lifecycle_msgs__srv__GetState_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__srv__GetState_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__srv__GetState_Request * ros_message = static_cast<lifecycle_msgs__srv__GetState_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__srv__GetState_Request(cdr, ros_message);
}
...
static size_t _GetState_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lifecycle_msgs__srv__GetState_Request(
...
using _GetState_Response__ros_msg_type = lifecycle_msgs__srv__GetState_Response;
  ...
  lifecycle_msgs__srv__GetState_Response * ros_message)
{
  // Field name: current_state
  {
    cdr_deserialize_lifecycle_msgs__msg__State(cdr, &ros_message->current_state);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs__srv__GetState_Response;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__srv__GetState_Response * ros_message = static_cast<const lifecycle_msgs__srv__GetState_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__srv__GetState_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__srv__GetState_Response * ros_message = static_cast<lifecycle_msgs__srv__GetState_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__srv__GetState_Response(cdr, ros_message);
}
...
static size_t _GetState_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lifecycle_msgs__srv__GetState_Response(
    full_bounded, is_plain, 0);
...
using _GetState_Event__ros_msg_type = lifecycle_msgs__srv__GetState_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_lifecycle_msgs__srv__GetState_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_lifecycle_msgs__srv__GetState_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  lifecycle_msgs__srv__GetState_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      lifecycle_msgs__srv__GetState_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_lifecycle_msgs__srv__GetState_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      lifecycle_msgs__srv__GetState_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_lifecycle_msgs__srv__GetState_Response(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_lifecycle_msgs__srv__GetState_Event(
  ...
  size_t current_alignment)
{
  const _GetState_Event__ros_msg_type * ros_message = static_cast<const _GetState_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_lifecycle_msgs__srv__GetState_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_lifecycle_msgs__srv__GetState_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_lifecycle_msgs__srv__GetState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs__srv__GetState_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_lifecycle_msgs__srv__GetState_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_lifecycle_msgs__srv__GetState_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_lifecycle_msgs__srv__GetState_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_lifecycle_msgs__srv__GetState_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_lifecycle_msgs__srv__GetState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_lifecycle_msgs__srv__GetState_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lifecycle_msgs__srv__GetState_Event * ros_message = static_cast<const lifecycle_msgs__srv__GetState_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lifecycle_msgs__srv__GetState_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lifecycle_msgs__srv__GetState_Event * ros_message = static_cast<lifecycle_msgs__srv__GetState_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lifecycle_msgs__srv__GetState_Event(cdr, ros_message);
}
...
static size_t _GetState_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lifecycle_msgs__srv__GetState_Event(
    full_bounded, is_plain, 0);
