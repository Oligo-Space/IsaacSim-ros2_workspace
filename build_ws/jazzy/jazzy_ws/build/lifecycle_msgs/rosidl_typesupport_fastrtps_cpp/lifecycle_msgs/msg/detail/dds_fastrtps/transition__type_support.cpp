...
#include "lifecycle_msgs/msg/detail/transition__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lifecycle_msgs::msg::Transition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lifecycle_msgs::msg::Transition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lifecycle_msgs::msg::Transition *>(
    untyped_ros_message);
...
{
  return &lifecycle_msgs::msg::typesupport_fastrtps_cpp::_Transition__handle;
}
