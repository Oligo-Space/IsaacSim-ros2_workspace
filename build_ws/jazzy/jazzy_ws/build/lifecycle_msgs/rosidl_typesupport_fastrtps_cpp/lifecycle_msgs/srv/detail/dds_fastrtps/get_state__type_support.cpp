...
#include "lifecycle_msgs/srv/detail/get_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lifecycle_msgs::srv::GetState_Request;
    is_plain =
      (
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetState_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs::srv::GetState_Response;
    is_plain =
      (
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetState_Response__handle;
}
...
// functions for lifecycle_msgs::srv::GetState_Request already declared above

// functions for lifecycle_msgs::srv::GetState_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetState_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs::srv::GetState_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetState_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const lifecycle_msgs::srv::GetState_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lifecycle_msgs::srv::GetState_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetState_Event__handle;
}
...
static const rosidl_service_type_support_t _GetState__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetState_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetState_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetState_Event>(),
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetState__handle;
}
