...
#include "lifecycle_msgs/srv/detail/get_available_states__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lifecycle_msgs::srv::GetAvailableStates_Request;
    is_plain =
      (
...
static size_t _GetAvailableStates_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetAvailableStates_Request(full_bounded, is_plain, 0);
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetAvailableStates_Request__handle;
}
  ...
  // Member: available_states
  {
    ...
    for (size_t i = 0; i < size; i++) {
      lifecycle_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.available_states[i]);
    }
  }
  ...
  // Member: available_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.available_states[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs::srv::GetAvailableStates_Response;
    is_plain =
      (
...
static size_t _GetAvailableStates_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetAvailableStates_Response(full_bounded, is_plain, 0);
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetAvailableStates_Response__handle;
}
...
// functions for lifecycle_msgs::srv::GetAvailableStates_Request already declared above

// functions for lifecycle_msgs::srv::GetAvailableStates_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetAvailableStates_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetAvailableStates_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lifecycle_msgs::srv::GetAvailableStates_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetAvailableStates_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lifecycle_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetAvailableStates_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const lifecycle_msgs::srv::GetAvailableStates_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lifecycle_msgs::srv::GetAvailableStates_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetAvailableStates_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lifecycle_msgs::srv::GetAvailableStates_Event *>(
...
static size_t _GetAvailableStates_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetAvailableStates_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetAvailableStates_Event__callbacks = {
  "lifecycle_msgs::srv",
...
static rosidl_message_type_support_t _GetAvailableStates_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetAvailableStates_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetAvailableStates_Event__handle;
}
...
static const rosidl_service_type_support_t _GetAvailableStates__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetAvailableStates__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetAvailableStates_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetAvailableStates_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lifecycle_msgs::srv::GetAvailableStates_Event>(),
...
{
  return &lifecycle_msgs::srv::typesupport_fastrtps_cpp::_GetAvailableStates__handle;
}
