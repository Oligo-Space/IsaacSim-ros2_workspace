...
: ${AMENT_CURRENT_PREFIX:="/workspace/jazzy_ws/install"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/launch_testing_ament_cmake/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/launch_testing_ament_cmake/environment/path.sh"
