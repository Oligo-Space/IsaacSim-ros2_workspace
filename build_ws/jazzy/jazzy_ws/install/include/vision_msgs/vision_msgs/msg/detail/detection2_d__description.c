...
vision_msgs__msg__Detection2D__get_type_hash(
...
static char vision_msgs__msg__Detection2D__FIELD_NAME__header[] = "header";
static char vision_msgs__msg__Detection2D__FIELD_NAME__results[] = "results";
static char vision_msgs__msg__Detection2D__FIELD_NAME__bbox[] = "bbox";
static char vision_msgs__msg__Detection2D__FIELD_NAME__id[] = "id";

static rosidl_runtime_c__type_description__Field vision_msgs__msg__Detection2D__FIELDS[] = {
  {
    {vision_msgs__msg__Detection2D__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {vision_msgs__msg__Detection2D__FIELD_NAME__results, 7, 7},
    {
  ...
  {
    {vision_msgs__msg__Detection2D__FIELD_NAME__bbox, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {vision_msgs__msg__Detection2D__FIELD_NAME__id, 2, 2},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription vision_msgs__msg__Detection2D__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
vision_msgs__msg__Detection2D__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {vision_msgs__msg__Detection2D__FIELDS, 4, 4},
    },
    {vision_msgs__msg__Detection2D__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[7].fields = vision_msgs__msg__ObjectHypothesis__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = vision_msgs__msg__ObjectHypothesisWithPose__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[10].fields = vision_msgs__msg__Pose2D__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
vision_msgs__msg__Detection2D__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
vision_msgs__msg__Detection2D__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *vision_msgs__msg__Detection2D__get_individual_type_description_source(NULL),
    ...
    sources[8] = *vision_msgs__msg__ObjectHypothesis__get_individual_type_description_source(NULL);
    sources[9] = *vision_msgs__msg__ObjectHypothesisWithPose__get_individual_type_description_source(NULL);
    sources[10] = *vision_msgs__msg__Point2D__get_individual_type_description_source(NULL);
    sources[11] = *vision_msgs__msg__Pose2D__get_individual_type_description_source(NULL);
    constructed = true;
  }
