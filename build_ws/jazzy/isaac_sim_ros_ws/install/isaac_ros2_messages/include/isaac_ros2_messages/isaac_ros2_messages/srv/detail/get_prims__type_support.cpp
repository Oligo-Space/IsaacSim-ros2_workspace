...
void GetPrims_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) isaac_ros2_messages::srv::GetPrims_Event(_init);
}

void GetPrims_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<isaac_ros2_messages::srv::GetPrims_Event *>(message_memory);
  typed_message->~GetPrims_Event();
}

size_t size_function__GetPrims_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<isaac_ros2_messages::srv::GetPrims_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__GetPrims_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<isaac_ros2_messages::srv::GetPrims_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__GetPrims_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<isaac_ros2_messages::srv::GetPrims_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__GetPrims_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const isaac_ros2_messages::srv::GetPrims_Request *>(
    get_const_function__GetPrims_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<isaac_ros2_messages::srv::GetPrims_Request *>(untyped_value);
  value = item;
}

void assign_function__GetPrims_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<isaac_ros2_messages::srv::GetPrims_Request *>(
    get_function__GetPrims_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const isaac_ros2_messages::srv::GetPrims_Request *>(untyped_value);
  item = value;
}

void resize_function__GetPrims_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<isaac_ros2_messages::srv::GetPrims_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__GetPrims_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<isaac_ros2_messages::srv::GetPrims_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__GetPrims_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<isaac_ros2_messages::srv::GetPrims_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__GetPrims_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<isaac_ros2_messages::srv::GetPrims_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__GetPrims_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const isaac_ros2_messages::srv::GetPrims_Response *>(
    get_const_function__GetPrims_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<isaac_ros2_messages::srv::GetPrims_Response *>(untyped_value);
  value = item;
}

void assign_function__GetPrims_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<isaac_ros2_messages::srv::GetPrims_Response *>(
    get_function__GetPrims_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const isaac_ros2_messages::srv::GetPrims_Response *>(untyped_value);
  item = value;
}

void resize_function__GetPrims_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<isaac_ros2_messages::srv::GetPrims_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetPrims_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros2_messages::srv::GetPrims_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<isaac_ros2_messages::srv::GetPrims_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(isaac_ros2_messages::srv::GetPrims_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__GetPrims_Event__request,  // size() function pointer
    get_const_function__GetPrims_Event__request,  // get_const(index) function pointer
    get_function__GetPrims_Event__request,  // get(index) function pointer
    fetch_function__GetPrims_Event__request,  // fetch(index, &value) function pointer
    assign_function__GetPrims_Event__request,  // assign(index, value) function pointer
    resize_function__GetPrims_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<isaac_ros2_messages::srv::GetPrims_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(isaac_ros2_messages::srv::GetPrims_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__GetPrims_Event__response,  // size() function pointer
    get_const_function__GetPrims_Event__response,  // get_const(index) function pointer
    get_function__GetPrims_Event__response,  // get(index) function pointer
    fetch_function__GetPrims_Event__response,  // fetch(index, &value) function pointer
    assign_function__GetPrims_Event__response,  // assign(index, value) function pointer
    resize_function__GetPrims_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetPrims_Event_message_members = {
  "isaac_ros2_messages::srv",  // message namespace
  "GetPrims_Event",  // message name
  3,  // number of fields
  sizeof(isaac_ros2_messages::srv::GetPrims_Event),
  false,  // has_any_key_member_
  GetPrims_Event_message_member_array,  // message members
  GetPrims_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  GetPrims_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t GetPrims_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &GetPrims_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<isaac_ros2_messages::srv::GetPrims_Event>()
{
  return &::isaac_ros2_messages::srv::rosidl_typesupport_introspection_cpp::GetPrims_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isaac_ros2_messages, srv, GetPrims_Event)() {
  return &::isaac_ros2_messages::srv::rosidl_typesupport_introspection_cpp::GetPrims_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetPrims_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<isaac_ros2_messages::srv::GetPrims_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<isaac_ros2_messages::srv::GetPrims_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<isaac_ros2_messages::srv::GetPrims_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<isaac_ros2_messages::srv::GetPrims>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<isaac_ros2_messages::srv::GetPrims>,
...
get_service_type_support_handle<isaac_ros2_messages::srv::GetPrims>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::isaac_ros2_messages::srv::GetPrims_Event
      >()->data
      );
  }
