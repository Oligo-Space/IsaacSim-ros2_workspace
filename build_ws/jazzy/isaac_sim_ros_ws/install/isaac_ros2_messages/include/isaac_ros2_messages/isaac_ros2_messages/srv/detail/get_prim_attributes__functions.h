...
#ifndef ISAAC_ROS2_MESSAGES__SRV__DETAIL__GET_PRIM_ATTRIBUTES__FUNCTIONS_H_
#define ISAAC_ROS2_MESSAGES__SRV__DETAIL__GET_PRIM_ATTRIBUTES__FUNCTIONS_H_
...
/// Initialize srv/GetPrimAttributes message.
/**
...
/// Finalize srv/GetPrimAttributes message.
/**
...
/// Create srv/GetPrimAttributes message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Request__init().
...
/// Destroy srv/GetPrimAttributes message.
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Request__fini()
...
/// Check for srv/GetPrimAttributes message equality.
/**
...
/// Copy a srv/GetPrimAttributes message.
/**
...
/// Initialize array of srv/GetPrimAttributes messages.
/**
...
/// Finalize array of srv/GetPrimAttributes messages.
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Request__fini()
...
/// Create array of srv/GetPrimAttributes messages.
/**
...
/// Destroy array of srv/GetPrimAttributes messages.
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetPrimAttributes message array equality.
/**
...
/// Copy an array of srv/GetPrimAttributes messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * isaac_ros2_messages__srv__GetPrimAttributes_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It allocates the memory for the array and calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__GetPrimAttributes_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ISAAC_ROS2_MESSAGES__SRV__DETAIL__GET_PRIM_ATTRIBUTES__FUNCTIONS_H_
