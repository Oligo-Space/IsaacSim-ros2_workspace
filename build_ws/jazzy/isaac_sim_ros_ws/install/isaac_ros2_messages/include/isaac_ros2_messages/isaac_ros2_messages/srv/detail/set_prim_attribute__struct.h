...
enum
{
  isaac_ros2_messages__srv__SetPrimAttribute_Event__request__MAX_SIZE = 1
};
// response
enum
{
  isaac_ros2_messages__srv__SetPrimAttribute_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetPrimAttribute in the package isaac_ros2_messages.
typedef struct isaac_ros2_messages__srv__SetPrimAttribute_Event
{
  service_msgs__msg__ServiceEventInfo info;
  isaac_ros2_messages__srv__SetPrimAttribute_Request__Sequence request;
  isaac_ros2_messages__srv__SetPrimAttribute_Response__Sequence response;
} isaac_ros2_messages__srv__SetPrimAttribute_Event;

// Struct for a sequence of isaac_ros2_messages__srv__SetPrimAttribute_Event.
typedef struct isaac_ros2_messages__srv__SetPrimAttribute_Event__Sequence
{
