...
#ifndef ISAAC_ROS2_MESSAGES__SRV__DETAIL__ISAAC_POSE__FUNCTIONS_H_
#define ISAAC_ROS2_MESSAGES__SRV__DETAIL__ISAAC_POSE__FUNCTIONS_H_
...
/// Initialize srv/IsaacPose message.
/**
...
/// Finalize srv/IsaacPose message.
/**
...
/// Create srv/IsaacPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__IsaacPose_Request__init().
...
/// Destroy srv/IsaacPose message.
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Request__fini()
...
/// Check for srv/IsaacPose message equality.
/**
...
/// Initialize array of srv/IsaacPose messages.
/**
...
/// Finalize array of srv/IsaacPose messages.
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Request__fini()
...
/// Create array of srv/IsaacPose messages.
/**
...
/// Destroy array of srv/IsaacPose messages.
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/IsaacPose message array equality.
/**
...
/// Copy an array of srv/IsaacPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__IsaacPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * isaac_ros2_messages__srv__IsaacPose_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__IsaacPose_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It allocates the memory for the array and calls
 * isaac_ros2_messages__srv__IsaacPose_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__IsaacPose_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ISAAC_ROS2_MESSAGES__SRV__DETAIL__ISAAC_POSE__FUNCTIONS_H_
