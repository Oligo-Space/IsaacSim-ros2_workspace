...
class Metaclass_GetPrims_Event(type):
    """Metaclass of message 'GetPrims_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_prims__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_prims__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_prims__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_prims__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_prims__event
...
class GetPrims_Event(metaclass=Metaclass_GetPrims_Event):
    """Message class 'GetPrims_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<isaac_ros2_messages/GetPrims_Request, 1>',
        'response': 'sequence<isaac_ros2_messages/GetPrims_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'GetPrims_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'GetPrims_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import GetPrims_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPrims_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPrims_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import GetPrims_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPrims_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPrims_Response'"
...
class Metaclass_GetPrims(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_prims.Metaclass_GetPrims_Event._TYPE_SUPPORT is None:
                _get_prims.Metaclass_GetPrims_Event.__import_type_support__()
...
class GetPrims(metaclass=Metaclass_GetPrims):
    ...
    from isaac_ros2_messages.srv._get_prims import GetPrims_Event as Event
