...
class Metaclass_GetPrimAttribute_Event(type):
    """Metaclass of message 'GetPrimAttribute_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_prim_attribute__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_prim_attribute__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_prim_attribute__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_prim_attribute__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_prim_attribute__event
...
class GetPrimAttribute_Event(metaclass=Metaclass_GetPrimAttribute_Event):
    """Message class 'GetPrimAttribute_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<isaac_ros2_messages/GetPrimAttribute_Request, 1>',
        'response': 'sequence<isaac_ros2_messages/GetPrimAttribute_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'GetPrimAttribute_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'GetPrimAttribute_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import GetPrimAttribute_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPrimAttribute_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPrimAttribute_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import GetPrimAttribute_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPrimAttribute_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPrimAttribute_Response'"
...
class Metaclass_GetPrimAttribute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from isaac_ros2_messages.srv import _get_prim_attribute
            ...
            if _get_prim_attribute.Metaclass_GetPrimAttribute_Event._TYPE_SUPPORT is None:
                _get_prim_attribute.Metaclass_GetPrimAttribute_Event.__import_type_support__()


class GetPrimAttribute(metaclass=Metaclass_GetPrimAttribute):
    from isaac_ros2_messages.srv._get_prim_attribute import GetPrimAttribute_Request as Request
    from isaac_ros2_messages.srv._get_prim_attribute import GetPrimAttribute_Response as Response
    from isaac_ros2_messages.srv._get_prim_attribute import GetPrimAttribute_Event as Event
