...
class Metaclass_IsaacPose_Event(type):
    """Metaclass of message 'IsaacPose_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__isaac_pose__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__isaac_pose__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__isaac_pose__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__isaac_pose__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__isaac_pose__event
...
class IsaacPose_Event(metaclass=Metaclass_IsaacPose_Event):
    """Message class 'IsaacPose_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<isaac_ros2_messages/IsaacPose_Request, 1>',
        'response': 'sequence<isaac_ros2_messages/IsaacPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'IsaacPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'IsaacPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import IsaacPose_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IsaacPose_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'IsaacPose_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import IsaacPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IsaacPose_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'IsaacPose_Response'"
...
class Metaclass_IsaacPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _isaac_pose.Metaclass_IsaacPose_Event._TYPE_SUPPORT is None:
                _isaac_pose.Metaclass_IsaacPose_Event.__import_type_support__()
...
class IsaacPose(metaclass=Metaclass_IsaacPose):
    ...
    from isaac_ros2_messages.srv._isaac_pose import IsaacPose_Event as Event
