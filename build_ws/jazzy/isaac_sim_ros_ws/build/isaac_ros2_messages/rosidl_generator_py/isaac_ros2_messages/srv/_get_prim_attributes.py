...
class Metaclass_GetPrimAttributes_Event(type):
    """Metaclass of message 'GetPrimAttributes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_prim_attributes__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_prim_attributes__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_prim_attributes__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_prim_attributes__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_prim_attributes__event
...
class GetPrimAttributes_Event(metaclass=Metaclass_GetPrimAttributes_Event):
    """Message class 'GetPrimAttributes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<isaac_ros2_messages/GetPrimAttributes_Request, 1>',
        'response': 'sequence<isaac_ros2_messages/GetPrimAttributes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'GetPrimAttributes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['isaac_ros2_messages', 'srv'], 'GetPrimAttributes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import GetPrimAttributes_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPrimAttributes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPrimAttributes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from isaac_ros2_messages.srv import GetPrimAttributes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPrimAttributes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPrimAttributes_Response'"
...
class Metaclass_GetPrimAttributes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from isaac_ros2_messages.srv import _get_prim_attributes
            ...
            if _get_prim_attributes.Metaclass_GetPrimAttributes_Event._TYPE_SUPPORT is None:
                _get_prim_attributes.Metaclass_GetPrimAttributes_Event.__import_type_support__()


class GetPrimAttributes(metaclass=Metaclass_GetPrimAttributes):
    from isaac_ros2_messages.srv._get_prim_attributes import GetPrimAttributes_Request as Request
    from isaac_ros2_messages.srv._get_prim_attributes import GetPrimAttributes_Response as Response
    from isaac_ros2_messages.srv._get_prim_attributes import GetPrimAttributes_Event as Event
