...
bool cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Request(
  const isaac_ros2_messages__srv__GetPrimAttributes_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Request(
  eprosima::fastcdr::Cdr & cdr,
  isaac_ros2_messages__srv__GetPrimAttributes_Request * ros_message)
{
  // Field name: path
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_serialize_key_isaac_ros2_messages__srv__GetPrimAttributes_Request(
  const isaac_ros2_messages__srv__GetPrimAttributes_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: path
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t get_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPrimAttributes_Request__ros_msg_type * ros_message = static_cast<const _GetPrimAttributes_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t max_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const isaac_ros2_messages__srv__GetPrimAttributes_Request * ros_message = static_cast<const isaac_ros2_messages__srv__GetPrimAttributes_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  isaac_ros2_messages__srv__GetPrimAttributes_Request * ros_message = static_cast<isaac_ros2_messages__srv__GetPrimAttributes_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Response(
  const isaac_ros2_messages__srv__GetPrimAttributes_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: names
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Response(
  eprosima::fastcdr::Cdr & cdr,
  isaac_ros2_messages__srv__GetPrimAttributes_Response * ros_message)
{
  // Field name: names
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_serialize_key_isaac_ros2_messages__srv__GetPrimAttributes_Response(
  const isaac_ros2_messages__srv__GetPrimAttributes_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: names
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t get_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPrimAttributes_Response__ros_msg_type * ros_message = static_cast<const _GetPrimAttributes_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t max_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const isaac_ros2_messages__srv__GetPrimAttributes_Response * ros_message = static_cast<const isaac_ros2_messages__srv__GetPrimAttributes_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  isaac_ros2_messages__srv__GetPrimAttributes_Response * ros_message = static_cast<isaac_ros2_messages__srv__GetPrimAttributes_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Response(cdr, ros_message);
}
...
using _GetPrimAttributes_Event__ros_msg_type = isaac_ros2_messages__srv__GetPrimAttributes_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  const isaac_ros2_messages__srv__GetPrimAttributes_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  eprosima::fastcdr::Cdr & cdr,
  isaac_ros2_messages__srv__GetPrimAttributes_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence__fini(&ros_message->request);
    }
    if (!isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence__fini(&ros_message->response);
    }
    if (!isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t get_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPrimAttributes_Event__ros_msg_type * ros_message = static_cast<const _GetPrimAttributes_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t max_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = isaac_ros2_messages__srv__GetPrimAttributes_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
bool cdr_serialize_key_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  const isaac_ros2_messages__srv__GetPrimAttributes_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_isaac_ros2_messages__srv__GetPrimAttributes_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_isaac_ros2_messages__srv__GetPrimAttributes_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t get_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPrimAttributes_Event__ros_msg_type * ros_message = static_cast<const _GetPrimAttributes_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros2_messages
size_t max_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_isaac_ros2_messages__srv__GetPrimAttributes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _GetPrimAttributes_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const isaac_ros2_messages__srv__GetPrimAttributes_Event * ros_message = static_cast<const isaac_ros2_messages__srv__GetPrimAttributes_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_isaac_ros2_messages__srv__GetPrimAttributes_Event(ros_message, cdr);
}

static bool _GetPrimAttributes_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  isaac_ros2_messages__srv__GetPrimAttributes_Event * ros_message = static_cast<isaac_ros2_messages__srv__GetPrimAttributes_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_isaac_ros2_messages__srv__GetPrimAttributes_Event(cdr, ros_message);
}

static uint32_t _GetPrimAttributes_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Event(
      untyped_ros_message, 0));
}

static size_t _GetPrimAttributes_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_isaac_ros2_messages__srv__GetPrimAttributes_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_GetPrimAttributes_Event = {
  "isaac_ros2_messages::srv",
  "GetPrimAttributes_Event",
  _GetPrimAttributes_Event__cdr_serialize,
  _GetPrimAttributes_Event__cdr_deserialize,
  _GetPrimAttributes_Event__get_serialized_size,
  _GetPrimAttributes_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _GetPrimAttributes_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GetPrimAttributes_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)() {
  return &_GetPrimAttributes_Event__type_support;
}
...
static rosidl_service_type_support_t GetPrimAttributes__handle = {
  ...
  &_GetPrimAttributes_Request__type_support,
  &_GetPrimAttributes_Response__type_support,
  &_GetPrimAttributes_Event__type_support,
