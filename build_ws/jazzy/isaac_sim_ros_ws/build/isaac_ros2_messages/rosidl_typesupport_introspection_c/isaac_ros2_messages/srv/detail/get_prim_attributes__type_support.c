...
void isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  isaac_ros2_messages__srv__GetPrimAttributes_Event__init(message_memory);
}

void isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_fini_function(void * message_memory)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Event__fini(message_memory);
}

size_t isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__size_function__GetPrimAttributes_Event__request(
  const void * untyped_member)
{
  const isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence * member =
    (const isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_const_function__GetPrimAttributes_Event__request(
  const void * untyped_member, size_t index)
{
  const isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence * member =
    (const isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence *)(untyped_member);
...
void * isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_function__GetPrimAttributes_Event__request(
  void * untyped_member, size_t index)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence * member =
    (isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__fetch_function__GetPrimAttributes_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const isaac_ros2_messages__srv__GetPrimAttributes_Request * item =
    ((const isaac_ros2_messages__srv__GetPrimAttributes_Request *)
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_const_function__GetPrimAttributes_Event__request(untyped_member, index));
  isaac_ros2_messages__srv__GetPrimAttributes_Request * value =
    (isaac_ros2_messages__srv__GetPrimAttributes_Request *)(untyped_value);
  *value = *item;
}

void isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__assign_function__GetPrimAttributes_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Request * item =
    ((isaac_ros2_messages__srv__GetPrimAttributes_Request *)
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_function__GetPrimAttributes_Event__request(untyped_member, index));
  const isaac_ros2_messages__srv__GetPrimAttributes_Request * value =
    (const isaac_ros2_messages__srv__GetPrimAttributes_Request *)(untyped_value);
  *item = *value;
}

bool isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__resize_function__GetPrimAttributes_Event__request(
  void * untyped_member, size_t size)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence * member =
    (isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence *)(untyped_member);
  isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence__fini(member);
  return isaac_ros2_messages__srv__GetPrimAttributes_Request__Sequence__init(member, size);
}

size_t isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__size_function__GetPrimAttributes_Event__response(
  const void * untyped_member)
{
  const isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence * member =
    (const isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_const_function__GetPrimAttributes_Event__response(
  const void * untyped_member, size_t index)
{
  const isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence * member =
    (const isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence *)(untyped_member);
...
void * isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_function__GetPrimAttributes_Event__response(
  void * untyped_member, size_t index)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence * member =
    (isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__fetch_function__GetPrimAttributes_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const isaac_ros2_messages__srv__GetPrimAttributes_Response * item =
    ((const isaac_ros2_messages__srv__GetPrimAttributes_Response *)
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_const_function__GetPrimAttributes_Event__response(untyped_member, index));
  isaac_ros2_messages__srv__GetPrimAttributes_Response * value =
    (isaac_ros2_messages__srv__GetPrimAttributes_Response *)(untyped_value);
  *value = *item;
}

void isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__assign_function__GetPrimAttributes_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Response * item =
    ((isaac_ros2_messages__srv__GetPrimAttributes_Response *)
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_function__GetPrimAttributes_Event__response(untyped_member, index));
  const isaac_ros2_messages__srv__GetPrimAttributes_Response * value =
    (const isaac_ros2_messages__srv__GetPrimAttributes_Response *)(untyped_value);
  *item = *value;
}

bool isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__resize_function__GetPrimAttributes_Event__response(
  void * untyped_member, size_t size)
{
  isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence * member =
    (isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence *)(untyped_member);
  isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence__fini(member);
  return isaac_ros2_messages__srv__GetPrimAttributes_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros2_messages__srv__GetPrimAttributes_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(isaac_ros2_messages__srv__GetPrimAttributes_Event, request),  // bytes offset in struct
    NULL,  // default value
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__size_function__GetPrimAttributes_Event__request,  // size() function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_const_function__GetPrimAttributes_Event__request,  // get_const(index) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_function__GetPrimAttributes_Event__request,  // get(index) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__fetch_function__GetPrimAttributes_Event__request,  // fetch(index, &value) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__assign_function__GetPrimAttributes_Event__request,  // assign(index, value) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__resize_function__GetPrimAttributes_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(isaac_ros2_messages__srv__GetPrimAttributes_Event, response),  // bytes offset in struct
    NULL,  // default value
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__size_function__GetPrimAttributes_Event__response,  // size() function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_const_function__GetPrimAttributes_Event__response,  // get_const(index) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__get_function__GetPrimAttributes_Event__response,  // get(index) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__fetch_function__GetPrimAttributes_Event__response,  // fetch(index, &value) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__assign_function__GetPrimAttributes_Event__response,  // assign(index, value) function pointer
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__resize_function__GetPrimAttributes_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_members = {
  "isaac_ros2_messages__srv",  // message namespace
  "GetPrimAttributes_Event",  // message name
  3,  // number of fields
  sizeof(isaac_ros2_messages__srv__GetPrimAttributes_Event),
  false,  // has_any_key_member_
  isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_member_array,  // message members
  isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_type_support_handle = {
  0,
  &isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_isaac_ros2_messages
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)() {
  isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Request)();
  isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Response)();
  if (!isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_type_support_handle.typesupport_identifier) {
    isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t isaac_ros2_messages__srv__detail__get_prim_attributes__rosidl_typesupport_introspection_c__GetPrimAttributes_service_type_support_handle = {
  ...
  &isaac_ros2_messages__srv__GetPrimAttributes_Request__rosidl_typesupport_introspection_c__GetPrimAttributes_Request_message_type_support_handle,
  &isaac_ros2_messages__srv__GetPrimAttributes_Response__rosidl_typesupport_introspection_c__GetPrimAttributes_Response_message_type_support_handle,
  &isaac_ros2_messages__srv__GetPrimAttributes_Event__rosidl_typesupport_introspection_c__GetPrimAttributes_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_isaac_ros2_messages
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)()->data;
  }
