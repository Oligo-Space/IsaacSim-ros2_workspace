...
class Init_IsaacPose_Event_response
{
public:
  explicit Init_IsaacPose_Event_response(::isaac_ros2_messages::srv::IsaacPose_Event & msg)
  : msg_(msg)
  {}
  ::isaac_ros2_messages::srv::IsaacPose_Event response(::isaac_ros2_messages::srv::IsaacPose_Event::_response_type arg)
  {
...
private:
  ::isaac_ros2_messages::srv::IsaacPose_Event msg_;
};

class Init_IsaacPose_Event_request
{
public:
  explicit Init_IsaacPose_Event_request(::isaac_ros2_messages::srv::IsaacPose_Event & msg)
  : msg_(msg)
  {}
  Init_IsaacPose_Event_response request(::isaac_ros2_messages::srv::IsaacPose_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_IsaacPose_Event_response(msg_);
  }
...
class Init_IsaacPose_Event_info
{
public:
  Init_IsaacPose_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_IsaacPose_Event_request info(::isaac_ros2_messages::srv::IsaacPose_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_IsaacPose_Event_request(msg_);
  }
...
template<>
inline
auto build<::isaac_ros2_messages::srv::IsaacPose_Event>()
{
  return isaac_ros2_messages::srv::builder::Init_IsaacPose_Event_info();
}
