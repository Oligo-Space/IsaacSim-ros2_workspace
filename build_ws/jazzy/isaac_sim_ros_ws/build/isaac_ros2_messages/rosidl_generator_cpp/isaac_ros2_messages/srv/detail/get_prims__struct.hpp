...
#ifndef _WIN32
# define DEPRECATED__isaac_ros2_messages__srv__GetPrims_Event __attribute__((deprecated))
#else
# define DEPRECATED__isaac_ros2_messages__srv__GetPrims_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct GetPrims_Event_
{
  using Type = GetPrims_Event_<ContainerAllocator>;

  explicit GetPrims_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit GetPrims_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<isaac_ros2_messages::srv::GetPrims_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<isaac_ros2_messages::srv::GetPrims_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<isaac_ros2_messages::srv::GetPrims_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<isaac_ros2_messages::srv::GetPrims_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<isaac_ros2_messages::srv::GetPrims_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<isaac_ros2_messages::srv::GetPrims_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<isaac_ros2_messages::srv::GetPrims_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<isaac_ros2_messages::srv::GetPrims_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__isaac_ros2_messages__srv__GetPrims_Event
    std::shared_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__isaac_ros2_messages__srv__GetPrims_Event
    std::shared_ptr<isaac_ros2_messages::srv::GetPrims_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const GetPrims_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using GetPrims_Event =
  isaac_ros2_messages::srv::GetPrims_Event_<std::allocator<void>>;
...
struct GetPrims
{
  ...
  using Event = isaac_ros2_messages::srv::GetPrims_Event;
};
