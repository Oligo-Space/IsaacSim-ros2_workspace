...
inline void to_flow_style_yaml(
  const GetPrimAttributes_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GetPrimAttributes_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use isaac_ros2_messages::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const isaac_ros2_messages::srv::GetPrimAttributes_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  isaac_ros2_messages::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use isaac_ros2_messages::srv::to_yaml() instead")]]
inline std::string to_yaml(const isaac_ros2_messages::srv::GetPrimAttributes_Event & msg)
{
  return isaac_ros2_messages::srv::to_yaml(msg);
}

template<>
inline const char * data_type<isaac_ros2_messages::srv::GetPrimAttributes_Event>()
{
  return "isaac_ros2_messages::srv::GetPrimAttributes_Event";
}

template<>
inline const char * name<isaac_ros2_messages::srv::GetPrimAttributes_Event>()
{
  return "isaac_ros2_messages/srv/GetPrimAttributes_Event";
}

template<>
struct has_fixed_size<isaac_ros2_messages::srv::GetPrimAttributes_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<isaac_ros2_messages::srv::GetPrimAttributes_Event>
  : std::integral_constant<bool, has_bounded_size<isaac_ros2_messages::srv::GetPrimAttributes_Request>::value && has_bounded_size<isaac_ros2_messages::srv::GetPrimAttributes_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<isaac_ros2_messages::srv::GetPrimAttributes_Event>
  : std::true_type {};
