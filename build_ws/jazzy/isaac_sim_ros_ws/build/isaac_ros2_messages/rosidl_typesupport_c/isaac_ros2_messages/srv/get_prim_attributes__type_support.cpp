...
static const _GetPrimAttributes_Request_type_support_symbol_names_t _GetPrimAttributes_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros2_messages, srv, GetPrimAttributes_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros2_messages, srv, GetPrimAttributes_Request)() {
  return &::isaac_ros2_messages::srv::rosidl_typesupport_c::GetPrimAttributes_Request_message_type_support_handle;
}
...
static const _GetPrimAttributes_Response_type_support_symbol_names_t _GetPrimAttributes_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros2_messages, srv, GetPrimAttributes_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros2_messages, srv, GetPrimAttributes_Response)() {
  return &::isaac_ros2_messages::srv::rosidl_typesupport_c::GetPrimAttributes_Response_message_type_support_handle;
}
...
typedef struct _GetPrimAttributes_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _GetPrimAttributes_Event_type_support_ids_t;

static const _GetPrimAttributes_Event_type_support_ids_t _GetPrimAttributes_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _GetPrimAttributes_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _GetPrimAttributes_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _GetPrimAttributes_Event_type_support_symbol_names_t _GetPrimAttributes_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)),
  }
};

typedef struct _GetPrimAttributes_Event_type_support_data_t
{
  void * data[2];
} _GetPrimAttributes_Event_type_support_data_t;

static _GetPrimAttributes_Event_type_support_data_t _GetPrimAttributes_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _GetPrimAttributes_Event_message_typesupport_map = {
  2,
  "isaac_ros2_messages",
  &_GetPrimAttributes_Event_message_typesupport_ids.typesupport_identifier[0],
  &_GetPrimAttributes_Event_message_typesupport_symbol_names.symbol_name[0],
  &_GetPrimAttributes_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t GetPrimAttributes_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_GetPrimAttributes_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros2_messages, srv, GetPrimAttributes_Event)() {
  return &::isaac_ros2_messages::srv::rosidl_typesupport_c::GetPrimAttributes_Event_message_type_support_handle;
}
...
static const _GetPrimAttributes_type_support_symbol_names_t _GetPrimAttributes_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros2_messages, srv, GetPrimAttributes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros2_messages, srv, GetPrimAttributes)),
  }
};
...
static const rosidl_service_type_support_t GetPrimAttributes_service_type_support_handle = {
  ...
  &GetPrimAttributes_Request_message_type_support_handle,
  &GetPrimAttributes_Response_message_type_support_handle,
  &GetPrimAttributes_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros2_messages, srv, GetPrimAttributes)() {
  return &::isaac_ros2_messages::srv::rosidl_typesupport_c::GetPrimAttributes_service_type_support_handle;
}
