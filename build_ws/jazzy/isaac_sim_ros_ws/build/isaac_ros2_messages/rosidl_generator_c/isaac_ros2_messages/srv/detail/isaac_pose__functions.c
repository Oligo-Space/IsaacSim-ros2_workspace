...
isaac_ros2_messages__srv__IsaacPose_Request__create(void)
{
...
isaac_ros2_messages__srv__IsaacPose_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
isaac_ros2_messages__srv__IsaacPose_Event__init(isaac_ros2_messages__srv__IsaacPose_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    isaac_ros2_messages__srv__IsaacPose_Event__fini(msg);
    return false;
  }
  // request
  if (!isaac_ros2_messages__srv__IsaacPose_Request__Sequence__init(&msg->request, 0)) {
    isaac_ros2_messages__srv__IsaacPose_Event__fini(msg);
    return false;
  }
  // response
  if (!isaac_ros2_messages__srv__IsaacPose_Response__Sequence__init(&msg->response, 0)) {
    isaac_ros2_messages__srv__IsaacPose_Event__fini(msg);
    return false;
  }
  return true;
...
void
isaac_ros2_messages__srv__IsaacPose_Event__fini(isaac_ros2_messages__srv__IsaacPose_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  isaac_ros2_messages__srv__IsaacPose_Request__Sequence__fini(&msg->request);
  // response
  isaac_ros2_messages__srv__IsaacPose_Response__Sequence__fini(&msg->response);
}

bool
isaac_ros2_messages__srv__IsaacPose_Event__are_equal(const isaac_ros2_messages__srv__IsaacPose_Event * lhs, const isaac_ros2_messages__srv__IsaacPose_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!isaac_ros2_messages__srv__IsaacPose_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!isaac_ros2_messages__srv__IsaacPose_Response__Sequence__are_equal(
...
bool
isaac_ros2_messages__srv__IsaacPose_Event__copy(
  const isaac_ros2_messages__srv__IsaacPose_Event * input,
  isaac_ros2_messages__srv__IsaacPose_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!isaac_ros2_messages__srv__IsaacPose_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!isaac_ros2_messages__srv__IsaacPose_Response__Sequence__copy(
...
isaac_ros2_messages__srv__IsaacPose_Event *
isaac_ros2_messages__srv__IsaacPose_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isaac_ros2_messages__srv__IsaacPose_Event * msg = (isaac_ros2_messages__srv__IsaacPose_Event *)allocator.allocate(sizeof(isaac_ros2_messages__srv__IsaacPose_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(isaac_ros2_messages__srv__IsaacPose_Event));
  bool success = isaac_ros2_messages__srv__IsaacPose_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
isaac_ros2_messages__srv__IsaacPose_Event__destroy(isaac_ros2_messages__srv__IsaacPose_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    isaac_ros2_messages__srv__IsaacPose_Event__fini(msg);
...
bool
isaac_ros2_messages__srv__IsaacPose_Event__Sequence__init(isaac_ros2_messages__srv__IsaacPose_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isaac_ros2_messages__srv__IsaacPose_Event * data = NULL;

  if (size) {
    data = (isaac_ros2_messages__srv__IsaacPose_Event *)allocator.zero_allocate(size, sizeof(isaac_ros2_messages__srv__IsaacPose_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = isaac_ros2_messages__srv__IsaacPose_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        isaac_ros2_messages__srv__IsaacPose_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
isaac_ros2_messages__srv__IsaacPose_Event__Sequence__fini(isaac_ros2_messages__srv__IsaacPose_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      isaac_ros2_messages__srv__IsaacPose_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
isaac_ros2_messages__srv__IsaacPose_Event__Sequence *
isaac_ros2_messages__srv__IsaacPose_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isaac_ros2_messages__srv__IsaacPose_Event__Sequence * array = (isaac_ros2_messages__srv__IsaacPose_Event__Sequence *)allocator.allocate(sizeof(isaac_ros2_messages__srv__IsaacPose_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = isaac_ros2_messages__srv__IsaacPose_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
isaac_ros2_messages__srv__IsaacPose_Event__Sequence__destroy(isaac_ros2_messages__srv__IsaacPose_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    isaac_ros2_messages__srv__IsaacPose_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
isaac_ros2_messages__srv__IsaacPose_Event__Sequence__are_equal(const isaac_ros2_messages__srv__IsaacPose_Event__Sequence * lhs, const isaac_ros2_messages__srv__IsaacPose_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!isaac_ros2_messages__srv__IsaacPose_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
isaac_ros2_messages__srv__IsaacPose_Event__Sequence__copy(
  const isaac_ros2_messages__srv__IsaacPose_Event__Sequence * input,
  isaac_ros2_messages__srv__IsaacPose_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(isaac_ros2_messages__srv__IsaacPose_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    isaac_ros2_messages__srv__IsaacPose_Event * data =
      (isaac_ros2_messages__srv__IsaacPose_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!isaac_ros2_messages__srv__IsaacPose_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          isaac_ros2_messages__srv__IsaacPose_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!isaac_ros2_messages__srv__IsaacPose_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
