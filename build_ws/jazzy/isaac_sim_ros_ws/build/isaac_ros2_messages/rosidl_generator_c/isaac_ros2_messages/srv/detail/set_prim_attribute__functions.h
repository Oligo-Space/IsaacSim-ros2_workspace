...
// IWYU pragma: private, include "isaac_ros2_messages/srv/set_prim_attribute.h"
 ...
 * )) before or use
 * isaac_ros2_messages__srv__SetPrimAttribute_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaac_ros2_messages__srv__SetPrimAttribute_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__SetPrimAttribute_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It allocates the memory for the array and calls
 * isaac_ros2_messages__srv__SetPrimAttribute_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaac_ros2_messages
...
/**
 * It calls
 * isaac_ros2_messages__srv__SetPrimAttribute_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
