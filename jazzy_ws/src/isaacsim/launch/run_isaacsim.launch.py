...
launch_args = [
    ...
    DeclareLaunchArgument('dds_type', default_value='fastdds', description='Set to "fastdds" or "cyclonedds" (Cyclone only supported for ROS 2 Jazzy) to run Isaac Sim with a specific dds type.'),
    ...
    DeclareLaunchArgument('ros_distro', default_value='jazzy', description='Provide ROS version to use. Only Jazzy is supported.'),
